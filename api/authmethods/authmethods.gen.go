...
func (c *Client) Create(ctx context.Context, resourceType string, opt ...Option) (*AuthMethod, *api.Error, error) {
...
func (c *Client) List(ctx context.Context, opt ...Option) ([]*AuthMethod, *api.Error, error) {
	if c.client == nil {
		return nil, nil, fmt.Errorf("nil client")
	}
...
func (c *Client) Create2(ctx context.Context, resourceType string, scopeId string, opt ...Option) (*AuthMethod, *api.Error, error) {
	if scopeId == "" {
...
func (c *Client) Read2(ctx context.Context, authMethodId string, opt ...Option) (*AuthMethod, *api.Error, error) {
	if authMethodId == "" {
		return nil, nil, fmt.Errorf("empty  authMethodId value passed into Read request")
	}
	if c.client == nil {
...
func (c *Client) Update2(ctx context.Context, authMethodId string, version uint32, opt ...Option) (*AuthMethod, *api.Error, error) {
	if authMethodId == "" {
		return nil, nil, fmt.Errorf("empty authMethodId value passed into Update request")
	}
	if c.client == nil {
	...
	if version == 0 {
		...
		existingTarget, existingApiErr, existingErr := c.Read2(ctx, authMethodId, opt...)
		if existingErr != nil {
			return nil, nil, fmt.Errorf("error performing initial check-and-set read: %w", existingErr)
		}
		if existingApiErr != nil {
...
func (c *Client) Delete2(ctx context.Context, authMethodId string, opt ...Option) (bool, *api.Error, error) {
	if authMethodId == "" {
		return false, nil, fmt.Errorf("empty authMethodId value passed into Delete request")
	}
	if c.client == nil {
...
func (c *Client) List2(ctx context.Context, scopeId string, opt ...Option) ([]*AuthMethod, *api.Error, error) {
	if scopeId == "" {
