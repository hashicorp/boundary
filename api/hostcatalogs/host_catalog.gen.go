...
func (c *Client) Create2(ctx context.Context, resourceType string, scopeId string, opt ...Option) (*HostCatalog, *api.Error, error) {
	if scopeId == "" {
...
func (c *Client) Read2(ctx context.Context, hostCatalogId string, opt ...Option) (*HostCatalog, *api.Error, error) {
	if hostCatalogId == "" {
		return nil, nil, fmt.Errorf("empty  hostCatalogId value passed into Read request")
	}
	if c.client == nil {
...
func (c *Client) Update2(ctx context.Context, hostCatalogId string, version uint32, opt ...Option) (*HostCatalog, *api.Error, error) {
	if hostCatalogId == "" {
		return nil, nil, fmt.Errorf("empty hostCatalogId value passed into Update request")
	}
	if c.client == nil {
	...
	if version == 0 {
		...
		existingTarget, existingApiErr, existingErr := c.Read2(ctx, hostCatalogId, opt...)
		if existingErr != nil {
			return nil, nil, fmt.Errorf("error performing initial check-and-set read: %w", existingErr)
		}
		if existingApiErr != nil {
...
func (c *Client) Delete2(ctx context.Context, hostCatalogId string, opt ...Option) (bool, *api.Error, error) {
	if hostCatalogId == "" {
		return false, nil, fmt.Errorf("empty hostCatalogId value passed into Delete request")
	}
	if c.client == nil {
...
func (c *Client) List2(ctx context.Context, scopeId string, opt ...Option) ([]*HostCatalog, *api.Error, error) {
	if scopeId == "" {
