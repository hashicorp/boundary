...
func (c *Client) Create2(ctx context.Context, hostCatalogId string, opt ...Option) (*Host, *api.Error, error) {
	if hostCatalogId == "" {
		return nil, nil, fmt.Errorf("empty hostCatalogId value passed into Create request")
	}
	opts, apiOpts := getOpts(opt...)
...
func (c *Client) Read2(ctx context.Context, hostId string, opt ...Option) (*Host, *api.Error, error) {
	if hostId == "" {
		return nil, nil, fmt.Errorf("empty  hostId value passed into Read request")
	}
	if c.client == nil {
...
func (c *Client) Update2(ctx context.Context, hostId string, version uint32, opt ...Option) (*Host, *api.Error, error) {
	if hostId == "" {
		return nil, nil, fmt.Errorf("empty hostId value passed into Update request")
	}
	if c.client == nil {
	...
	if version == 0 {
		...
		existingTarget, existingApiErr, existingErr := c.Read2(ctx, hostId, opt...)
		if existingErr != nil {
			return nil, nil, fmt.Errorf("error performing initial check-and-set read: %w", existingErr)
		}
		if existingApiErr != nil {
...
func (c *Client) Delete2(ctx context.Context, hostId string, opt ...Option) (bool, *api.Error, error) {
	if hostId == "" {
		return false, nil, fmt.Errorf("empty hostId value passed into Delete request")
	}
	if c.client == nil {
...
func (c *Client) List2(ctx context.Context, hostCatalogId string, opt ...Option) ([]*Host, *api.Error, error) {
	if hostCatalogId == "" {
		return nil, nil, fmt.Errorf("empty hostCatalogId value passed into List request")
	}
	if c.client == nil {
