...
func (c *Client) Create2(ctx context.Context, authMethodId string, opt ...Option) (*Account, *api.Error, error) {
	if authMethodId == "" {
		return nil, nil, fmt.Errorf("empty authMethodId value passed into Create request")
	}
	opts, apiOpts := getOpts(opt...)
...
func (c *Client) Read2(ctx context.Context, accountId string, opt ...Option) (*Account, *api.Error, error) {
	if accountId == "" {
		return nil, nil, fmt.Errorf("empty  accountId value passed into Read request")
	}
	if c.client == nil {
...
func (c *Client) Update2(ctx context.Context, accountId string, version uint32, opt ...Option) (*Account, *api.Error, error) {
	if accountId == "" {
		return nil, nil, fmt.Errorf("empty accountId value passed into Update request")
	}
	if c.client == nil {
...
func (c *Client) Delete2(ctx context.Context, accountId string, opt ...Option) (bool, *api.Error, error) {
	if accountId == "" {
		return false, nil, fmt.Errorf("empty accountId value passed into Delete request")
	}
	if c.client == nil {
...
func (c *Client) List2(ctx context.Context, authMethodId string, opt ...Option) ([]*Account, *api.Error, error) {
	if authMethodId == "" {
		return nil, nil, fmt.Errorf("empty authMethodId value passed into List request")
	}
	if c.client == nil {
