...
func (c *Client) Create2(ctx context.Context, scopeId string, opt ...Option) (*Scope, *api.Error, error) {
	if scopeId == "" {
		return nil, nil, fmt.Errorf("empty scopeId value passed into Create request")
	}
	opts, apiOpts := getOpts(opt...)
...
func (c *Client) Read2(ctx context.Context, scopeId string, opt ...Option) (*Scope, *api.Error, error) {
	if scopeId == "" {
		return nil, nil, fmt.Errorf("empty  scopeId value passed into Read request")
	}
	if c.client == nil {
...
func (c *Client) Update2(ctx context.Context, scopeId string, version uint32, opt ...Option) (*Scope, *api.Error, error) {
	if scopeId == "" {
		return nil, nil, fmt.Errorf("empty scopeId value passed into Update request")
	}
	if c.client == nil {
	...
	if version == 0 {
		...
		existingTarget, existingApiErr, existingErr := c.Read2(ctx, scopeId, opt...)
		if existingErr != nil {
			return nil, nil, fmt.Errorf("error performing initial check-and-set read: %w", existingErr)
		}
		if existingApiErr != nil {
...
func (c *Client) Delete2(ctx context.Context, scopeId string, opt ...Option) (bool, *api.Error, error) {
	if scopeId == "" {
		return false, nil, fmt.Errorf("empty scopeId value passed into Delete request")
	}
	if c.client == nil {
...
func (c *Client) List2(ctx context.Context, scopeId string, opt ...Option) ([]*Scope, *api.Error, error) {
	if scopeId == "" {
		return nil, nil, fmt.Errorf("empty scopeId value passed into List request")
	}
	if c.client == nil {
