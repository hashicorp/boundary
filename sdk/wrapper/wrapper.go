...
import (
	...
	kmsplugins "github.com/hashicorp/boundary/sdk/kms/plugins"
...
func getWrapper(ctx context.Context, kmses []*configutil.KMS, purpose string) (wrapping.Wrapper, func() error, error) {
	...
	wrapper, cleanup, err := configutil.ConfigureWrapper(ctx, kms, nil, nil, configutil.WithKmsPlugins(kmsplugins.FileSystem()))
	if err != nil {
