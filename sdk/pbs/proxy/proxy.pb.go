...
var file_worker_proxy_v1_proxy_proto_rawDesc = []byte{
	...
	0x2f, 0x73, 0x64, 0x6b, 0x2f, 0x70, 0x62, 0x73, 0x2f, 0x70, 0x72, 0x6f, 0x78, 0x79, 0x3b, 0x70,
...
func file_worker_proxy_v1_proxy_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_worker_proxy_v1_proxy_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_worker_proxy_v1_proxy_proto_msgTypes[1].Exporter = func(v any, i int) any {
