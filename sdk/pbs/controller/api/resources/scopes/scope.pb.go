...
type KeyVersionDestructionJob struct {
	...
	CompletedCount uint32 `protobuf:"varint,50,opt,name=completed_count,json=completedCount,proto3" json:"completed_count,omitempty"`
	// The total number of rows that need re-encrypting.
	TotalCount uint32 `protobuf:"varint,60,opt,name=total_count,json=totalCount,proto3" json:"total_count,omitempty"`
}
...
func (x *KeyVersionDestructionJob) GetCompletedCount() uint32 {
	if x != nil {
...
func (x *KeyVersionDestructionJob) GetTotalCount() uint32 {
	if x != nil {
		return x.TotalCount
	}
	return 0
...
var file_controller_api_resources_scopes_v1_scope_proto_rawDesc = []byte{
	...
	0x64, 0x5f, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x32, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0e, 0x63,
	...
	0x28, 0x0d, 0x52, 0x0a, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x42, 0x4e,
