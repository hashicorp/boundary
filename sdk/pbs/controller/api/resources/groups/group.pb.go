...
func file_controller_api_resources_groups_v1_group_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_controller_api_resources_groups_v1_group_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Member); i {
			case 0:
				return &v.state
			case 1:
		...
		file_controller_api_resources_groups_v1_group_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Group); i {
			case 0:
				return &v.state
			case 1:
