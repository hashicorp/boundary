...
type ManagedGroup_Attributes struct {
	...
	Attributes *structpb.Struct `protobuf:"bytes,100,opt,name=attributes,proto3,oneof"` // @gotags: `class:"public"`
}

type ManagedGroup_OidcManagedGroupAttributes struct {
	OidcManagedGroupAttributes *OidcManagedGroupAttributes `protobuf:"bytes,101,opt,name=oidc_managed_group_attributes,json=oidcManagedGroupAttributes,proto3,oneof"` // @gotags: `class:"public"`
}
