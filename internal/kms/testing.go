...
func TestRootKey(t *testing.T, conn *db.DB, scopeId string) *RootKey {
	...
	db.TestDeleteWhere(t, conn, AllocRootKey(), "scope_id = ?", scopeId)
	rw := db.New(conn)
...
func TestDatabaseKey(t *testing.T, conn *db.DB, rootKeyId string) *DatabaseKey {
	...
	require := require.New(t)
	rw := db.New(conn)
	db.TestDeleteWhere(t, conn, AllocDatabaseKey(), "root_key_id = ?", rootKeyId)
...
func TestOplogKey(t *testing.T, conn *db.DB, rootKeyId string) *OplogKey {
	...
	require := require.New(t)
	rw := db.New(conn)
	db.TestDeleteWhere(t, conn, AllocOplogKey(), "root_key_id = ?", rootKeyId)
...
func TestTokenKey(t *testing.T, conn *db.DB, rootKeyId string) *TokenKey {
	t.Helper()
	require := require.New(t)
	db.TestDeleteWhere(t, conn, AllocTokenKey(), "root_key_id = ?", rootKeyId)
	rw := db.New(conn)
...
func TestSessionKey(t *testing.T, conn *db.DB, rootKeyId string) *SessionKey {
	t.Helper()
	require := require.New(t)
	db.TestDeleteWhere(t, conn, AllocSessionKey(), "root_key_id = ?", rootKeyId)
	rw := db.New(conn)
...
func TestOidcKey(t *testing.T, conn *db.DB, rootKeyId string) *OidcKey {
	t.Helper()
	require := require.New(t)
	db.TestDeleteWhere(t, conn, AllocOidcKey(), "root_key_id = ?", rootKeyId)
	rw := db.New(conn)
...
func TestAuditKey(t *testing.T, conn *db.DB, rootKeyId string) *AuditKey {
	...
	require := require.New(t)
	db.TestDeleteWhere(t, conn, AllocAuditKey(), "root_key_id = ?", rootKeyId)
	rw := db.New(conn)
