...
type DataKeyVersionDestructionJobProgress struct {
	...
	// @inject_tag: `gorm:"not_null"`
	CompletedCount uint32 `protobuf:"varint,60,opt,name=completed_count,json=completedCount,proto3" json:"completed_count,omitempty"`
	// The total number of rows that need rewrapping
	// @inject_tag: `gorm:"not_null"`
	TotalCount uint32 `protobuf:"varint,70,opt,name=total_count,json=totalCount,proto3" json:"total_count,omitempty"`
}
...
func (x *DataKeyVersionDestructionJobProgress) GetCompletedCount() uint32 {
	if x != nil {
...
func (x *DataKeyVersionDestructionJobProgress) GetTotalCount() uint32 {
	if x != nil {
		return x.TotalCount
	}
	return 0
...
var file_controller_storage_kms_store_v1_data_key_version_destruction_job_progress_proto_rawDesc = []byte{
	...
	0x5f, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x3c, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0e, 0x63, 0x6f,
	0x6d, 0x70, 0x6c, 0x65, 0x74, 0x65, 0x64, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x1f, 0x0a, 0x0b,
	0x74, 0x6f, 0x74, 0x61, 0x6c, 0x5f, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x46, 0x20, 0x01, 0x28,
	0x0d, 0x52, 0x0a, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x42, 0x38, 0x5a,
