...
func file_controller_storage_kms_store_v1_root_key_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_controller_storage_kms_store_v1_root_key_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_controller_storage_kms_store_v1_root_key_proto_msgTypes[1].Exporter = func(v any, i int) any {
