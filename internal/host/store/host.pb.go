...
type Set struct {
	...
	Version uint32 `protobuf:"varint,3,opt,name=version,proto3" json:"version,omitempty" gorm:"default:null"`
}
...
func (x *SetMember) GetHostId() string {
	if x != nil {
		return x.HostId
	}
	return ""
...
func (x *SetMember) GetSetId() string {
	if x != nil {
		return x.SetId
	}
	return ""
...
func (x *SetMember) GetCatalogId() string {
	if x != nil {
		return x.CatalogId
	}
	return ""
...
func (x *DnsName) Reset() {
	*x = DnsName{}
	if protoimpl.UnsafeEnabled {
		mi := &file_controller_storage_host_store_v1_host_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DnsName) Descriptor() ([]byte, []int) {
	return file_controller_storage_host_store_v1_host_proto_rawDescGZIP(), []int{6}
}
...
var file_controller_storage_host_store_v1_host_proto_rawDesc = []byte{
	...
	0x61, 0x6c, 0x6f, 0x67, 0x49, 0x64, 0x22, 0x5b, 0x0a, 0x03, 0x53, 0x65, 0x74, 0x12, 0x1b, 0x0a,
	...
	0x69, 0x6f, 0x6e, 0x22, 0x5a, 0x0a, 0x09, 0x53, 0x65, 0x74, 0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72,
	0x12, 0x17, 0x0a, 0x07, 0x68, 0x6f, 0x73, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x06, 0x68, 0x6f, 0x73, 0x74, 0x49, 0x64, 0x12, 0x15, 0x0a, 0x06, 0x73, 0x65, 0x74,
	0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x73, 0x65, 0x74, 0x49, 0x64,
	...
	0x6d, 0x0a, 0x11, 0x50, 0x72, 0x65, 0x66, 0x65, 0x72, 0x72, 0x65, 0x64, 0x45, 0x6e, 0x64, 0x70,
	0x6f, 0x69, 0x6e, 0x74, 0x12, 0x1e, 0x0a, 0x0b, 0x68, 0x6f, 0x73, 0x74, 0x5f, 0x73, 0x65, 0x74,
	0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x68, 0x6f, 0x73, 0x74, 0x53,
	...
	,
	...
	0x6d, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x42, 0x39,
	...
	0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x2f, 0x68, 0x6f, 0x73, 0x74, 0x2f, 0x73, 0x74,
...
var file_controller_storage_host_store_v1_host_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_controller_storage_host_store_v1_host_proto_goTypes = []interface{}{
	...
	(*SetMember)(nil),         // 3: controller.storage.host.store.v1.SetMember
	(*PreferredEndpoint)(nil), // 4: controller.storage.host.store.v1.PreferredEndpoint
	(*IpAddress)(nil),         // 5: controller.storage.host.store.v1.IpAddress
	(*DnsName)(nil),           // 6: controller.storage.host.store.v1.DnsName
}
...
func file_controller_storage_host_store_v1_host_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_controller_storage_host_store_v1_host_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
