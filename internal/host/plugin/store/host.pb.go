...
type HostCatalogSecret struct {
	...
	// @inject_tag: `gorm:"not_null"`
	TtlSeconds int32 `protobuf:"varint,7,opt,name=ttl_seconds,json=ttlSeconds,proto3" json:"ttl_seconds,omitempty" gorm:"not_null"`
}
...
func (x *HostCatalogSecret) GetTtlSeconds() int32 {
	if x != nil {
		return x.TtlSeconds
	}
	return 0
...
var file_controller_storage_host_plugin_store_v1_host_proto_rawDesc = []byte{
	...
	0x07, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0a, 0x74, 0x74, 0x6c, 0x53, 0x65, 0x63, 0x6f, 0x6e, 0x64,
