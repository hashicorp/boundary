...
type Host struct {
	...
	// dns_addresses are the dns addresses associated with this host and will
	// be persisted in the db through the HostAddress message.
	// @inject_tag: `gorm:"-"`
	DnsAddresses []string `protobuf:"bytes,10,rep,name=dns_addresses,json=dnsAddresses,proto3" json:"dns_addresses,omitempty" gorm:"-"`
}
...
func (x *Host) GetDnsAddresses() []string {
	if x != nil {
		return x.DnsAddresses
	}
	return nil
}
...
func (x *HostAddress) GetHostId() string {
	if x != nil {
		return x.HostId
	}
	return ""
...
func (x *HostSetMember) Reset() {
	*x = HostSetMember{}
	if protoimpl.UnsafeEnabled {
		mi := &file_controller_storage_host_plugin_store_v1_host_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*HostSetMember) Descriptor() ([]byte, []int) {
	return file_controller_storage_host_plugin_store_v1_host_proto_rawDescGZIP(), []int{5}
}
...
var file_controller_storage_host_plugin_store_v1_host_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x05, 0x6b, 0x65, 0x79, 0x49, 0x64, 0x22, 0x95, 0x03, 0x0a, 0x04, 0x48, 0x6f,
	...
	,
...
var file_controller_storage_host_plugin_store_v1_host_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_controller_storage_host_plugin_store_v1_host_proto_goTypes = []interface{}{
	...
	(*HostAddress)(nil),         // 4: controller.storage.host.plugin.store.v1.HostAddress
	(*HostSetMember)(nil),       // 5: controller.storage.host.plugin.store.v1.HostSetMember
...
var file_controller_storage_host_plugin_store_v1_host_proto_depIdxs = []int32{
	6, // 0: controller.storage.host.plugin.store.v1.HostCatalog.create_time:type_name -> controller.storage.timestamp.v1.Timestamp
	6, // 1: controller.storage.host.plugin.store.v1.HostCatalog.update_time:type_name -> controller.storage.timestamp.v1.Timestamp
	6, // 2: controller.storage.host.plugin.store.v1.HostSet.create_time:type_name -> controller.storage.timestamp.v1.Timestamp
	6, // 3: controller.storage.host.plugin.store.v1.HostSet.update_time:type_name -> controller.storage.timestamp.v1.Timestamp
	6, // 4: controller.storage.host.plugin.store.v1.HostCatalogSecret.create_time:type_name -> controller.storage.timestamp.v1.Timestamp
	6, // 5: controller.storage.host.plugin.store.v1.HostCatalogSecret.update_time:type_name -> controller.storage.timestamp.v1.Timestamp
	6, // 6: controller.storage.host.plugin.store.v1.Host.create_time:type_name -> controller.storage.timestamp.v1.Timestamp
	6, // 7: controller.storage.host.plugin.store.v1.Host.update_time:type_name -> controller.storage.timestamp.v1.Timestamp
...
func file_controller_storage_host_plugin_store_v1_host_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_controller_storage_host_plugin_store_v1_host_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
