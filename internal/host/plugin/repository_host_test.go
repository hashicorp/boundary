...
func TestRepository_ListHostsByCatalogId(t *testing.T) {
	...
	t.Run("no-options", func(t *testing.T) {
		got, retPlg, err := repo.listHostsByCatalogId(ctx, catalog.GetPublicId())
		require.NoError(t, err)
	...
	t.Run("withStartPageAfter", func(t *testing.T) {
		...
		page1, retPlg, err := repo.listHostsByCatalogId(
			context.Background(),
			catalog.GetPublicId(),
			WithLimit(2),
		)
		...
		page2, retPlg, err := repo.listHostsByCatalogId(
			context.Background(),
			catalog.GetPublicId(),
			WithLimit(2),
		...
		page3, retPlg, err := repo.listHostsByCatalogId(
			context.Background(),
			catalog.GetPublicId(),
			WithLimit(2),
		...
		page4, retPlg, err := repo.listHostsByCatalogId(
			context.Background(),
			catalog.GetPublicId(),
			WithLimit(2),
