...
// ReplaceSetMembers replaces the hosts in setId with hostIds in the
...
func (r *Repository) ReplaceSetMembers(ctx context.Context, scopeId string, setId string, version uint32, hostIds []string, opt ...Option) ([]*HostSetMember, error) {
	panic("not implemented")
}
