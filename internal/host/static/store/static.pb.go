...
func file_controller_storage_host_static_store_v1_static_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_controller_storage_host_static_store_v1_static_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_controller_storage_host_static_store_v1_static_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Host); i {
			case 0:
				return &v.state
			case 1:
		...
		file_controller_storage_host_static_store_v1_static_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_controller_storage_host_static_store_v1_static_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_controller_storage_host_static_store_v1_static_proto_msgTypes[4].Exporter = func(v any, i int) any {
