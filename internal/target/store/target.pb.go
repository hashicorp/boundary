...
var file_controller_storage_target_store_v1_target_proto_rawDesc = []byte{
	...
	0x65, 0x54, 0x69, 0x6d, 0x65, 0x22, 0x8f, 0x01, 0x0a, 0x0a, 0x54, 0x61, 0x72, 0x67, 0x65, 0x74,
	0x48, 0x6f, 0x73, 0x74, 0x12, 0x1b, 0x0a, 0x09, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x5f, 0x69,
	0x64, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x49,
	0x64, 0x12, 0x17, 0x0a, 0x07, 0x68, 0x6f, 0x73, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x14, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x06, 0x68, 0x6f, 0x73, 0x74, 0x49, 0x64, 0x12, 0x4b, 0x0a, 0x0b, 0x63, 0x72,
	...
	0x61, 0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x22, 0xc6, 0x05, 0x0a, 0x09, 0x54, 0x63, 0x70, 0x54,
...
var file_controller_storage_target_store_v1_target_proto_goTypes = []interface{}{
	...
	(*TargetHost)(nil),          // 2: controller.storage.target.store.v1.TargetHost
	(*TcpTarget)(nil),           // 3: controller.storage.target.store.v1.TcpTarget
...
var file_controller_storage_target_store_v1_target_proto_depIdxs = []int32{
	...
	4, // 3: controller.storage.target.store.v1.TargetHost.create_time:type_name -> controller.storage.timestamp.v1.Timestamp
	4, // 4: controller.storage.target.store.v1.TcpTarget.create_time:type_name -> controller.storage.timestamp.v1.Timestamp
	4, // 5: controller.storage.target.store.v1.TcpTarget.update_time:type_name -> controller.storage.timestamp.v1.Timestamp
