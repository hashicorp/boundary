...
func (x *AuthMethod) GetMinUserNameLength() string {
	if x != nil {
...
func (x *AuthMethod) GetMinPasswordLength() string {
	if x != nil {
...
var file_controller_storage_auth_password_store_v1_password_proto_rawDesc = []byte{
	...
	0x65, 0x6e, 0x67, 0x74, 0x68, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x11, 0x6d, 0x69, 0x6e,
	...
	0x65, 0x6e, 0x67, 0x74, 0x68, 0x18, 0x08, 0x20, 0x01, 0x28, 0x09, 0x52, 0x11, 0x6d, 0x69, 0x6e,
