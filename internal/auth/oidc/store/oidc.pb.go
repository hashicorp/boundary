...
type AuthMethod struct {
	...
	// @inject_tag: `gorm:"not_null"`
	State string `protobuf:"bytes,8,opt,name=state,proto3" json:"state,omitempty" gorm:"not_null"`
	// discovery_url is the OIDC Discovery URL without any .well-known component
	// @inject_tag: `gorm:"not_null"`
	DiscoveryUrl string `protobuf:"bytes,9,opt,name=discovery_url,json=discoveryUrl,proto3" json:"discovery_url,omitempty" gorm:"not_null"`
	// client_id is the OIDC client identifier
	// @inject_tag: `gorm:"not_null"`
	ClientId string `protobuf:"bytes,10,opt,name=client_id,json=clientId,proto3" json:"client_id,omitempty" gorm:"not_null"`
	...
	CtClientSecret []byte `protobuf:"bytes,11,opt,name=ct_client_secret,json=ctClientSecret,proto3" json:"ct_client_secret,omitempty" gorm:"column:client_secret;not_null" wrapping:"ct,client_secret"`
	...
	ClientSecret string `protobuf:"bytes,12,opt,name=client_secret,json=clientSecret,proto3" json:"client_secret,omitempty" gorm:"-" wrapping:"pt,client_secret"`
	...
	// @inject_tag: `gorm:"not_null"`
	KeyId string `protobuf:"bytes,13,opt,name=key_id,json=keyId,proto3" json:"key_id,omitempty" gorm:"not_null"`
	...
	// @inject_tag: `gorm:"not_null"`
	MaxAge uint32 `protobuf:"varint,14,opt,name=max_age,json=maxAge,proto3" json:"max_age,omitempty" gorm:"not_null"`
}
...
func (x *AuthMethod) GetMaxAge() uint32 {
	if x != nil {
		return x.MaxAge
	}
	return 0
...
type Account struct {
	...
	// @inject_tag: `gorm:"not_null"`
	IssuerId string `protobuf:"bytes,8,opt,name=issuer_id,json=issuerId,proto3" json:"issuer_id,omitempty" gorm:"not_null"`
	// subject_id is a case sensitive string that maps to the OIDC sub claim.
	// @inject_tag: `gorm:"not_null"`
	SubjectId string `protobuf:"bytes,9,opt,name=subject_id,json=subjectId,proto3" json:"subject_id,omitempty" gorm:"not_null"`
	// full_name is a string that maps to the OIDC name claim
	// @inject_tag: `gorm:"not_null"`
	FullName string `protobuf:"bytes,10,opt,name=full_name,json=fullName,proto3" json:"full_name,omitempty" gorm:"not_null"`
	// email is a string that maps to the OIDC email claim.
	// @inject_tag: `gorm:"not_null"`
	Email string `protobuf:"bytes,11,opt,name=email,proto3" json:"email,omitempty" gorm:"not_null"`
}
...
type SigningAlg struct {
	...
	// @inject_tag `gorm:"primary_key"`
	OidcMethodId string `protobuf:"bytes,1,opt,name=oidc_method_id,json=oidcMethodId,proto3" json:"oidc_method_id,omitempty"`
	// signing_alg_name is an enum from the auth_oidc_signing_alg_enm table
	// @inject_tag `gorm:"primary_key"`
	SigningAlgName string `protobuf:"bytes,2,opt,name=signing_alg_name,json=signingAlgName,proto3" json:"signing_alg_name,omitempty"`
}
...
func (x *SigningAlg) GetSigningAlgName() string {
	if x != nil {
		return x.SigningAlgName
	}
	return ""
}
...
func (x *CallbackUrl) GetCallbackUrl() string {
	if x != nil {
...
type AudClaim struct {
	...
	// @inject_tag `gorm:"primary_key"`
	AudClaim string `protobuf:"bytes,2,opt,name=aud_claim,json=audClaim,proto3" json:"aud_claim,omitempty"`
}
...
func (x *AudClaim) GetAudClaim() string {
	if x != nil {
		return x.AudClaim
	}
	return ""
...
var file_controller_storage_auth_oidc_store_v1_oidc_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xb3, 0x05, 0x0a, 0x0a, 0x41, 0x75, 0x74, 0x68, 0x4d,
	...
	0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x73, 0x63, 0x6f, 0x70, 0x65, 0x49, 0x64, 0x12,
	...
	,
	...
	,
	...
	,
	...
	0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x65, 0x42, 0x3e, 0x5a, 0x3c, 0x67, 0x69, 0x74, 0x68,
