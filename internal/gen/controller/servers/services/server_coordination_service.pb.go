...
type StatusResponse struct {
	...
	AuthroizedWorkerKeyIdentifiers []string `protobuf:"bytes,50,rep,name=authroized_worker_key_identifiers,json=authroizedWorkerKeyIdentifiers,proto3" json:"authroized_worker_key_identifiers,omitempty"`
}
...
func (x *StatusResponse) GetAuthroizedWorkerKeyIdentifiers() []string {
	if x != nil {
		return x.AuthroizedWorkerKeyIdentifiers
	}
	return nil
}
...
var file_controller_servers_services_v1_server_coordination_service_proto_rawDesc = []byte{
	...
	0x21, 0x61, 0x75, 0x74, 0x68, 0x72, 0x6f, 0x69, 0x7a, 0x65, 0x64, 0x5f, 0x77, 0x6f, 0x72, 0x6b,
	0x65, 0x72, 0x5f, 0x6b, 0x65, 0x79, 0x5f, 0x69, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x66, 0x69, 0x65,
	0x72, 0x73, 0x18, 0x32, 0x20, 0x03, 0x28, 0x09, 0x52, 0x1e, 0x61, 0x75, 0x74, 0x68, 0x72, 0x6f,
