...
func (x *GetSessionResponse) GetAuthorization() *targets.SessionAuthorizationData {
	if x != nil {
...
func (x *GetSessionResponse) GetTofuToken() string {
	if x != nil {
		return x.TofuToken
	}
	return ""
...
func (x *GetSessionResponse) GetVersion() uint32 {
	if x != nil {
		return x.Version
	}
	return 0
...
var file_controller_servers_services_v1_session_service_proto_rawDesc = []byte{
	...
	0x31, 0x2f, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x32,
	...
	0x49, 0x64, 0x22, 0xb2, 0x01, 0x0a, 0x12, 0x47, 0x65, 0x74, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f,
	...
	0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x32, 0x87, 0x01, 0x0a, 0x0e, 0x53, 0x65, 0x73, 0x73,
	0x69, 0x6f, 0x6e, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x75, 0x0a, 0x0a, 0x47, 0x65,
	0x74, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x31, 0x2e, 0x63, 0x6f, 0x6e, 0x74, 0x72,
	...
	0x73, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x32, 0x2e, 0x63, 0x6f,
...
var file_controller_servers_services_v1_session_service_proto_goTypes = []interface{}{
	...
	(*targets.SessionAuthorizationData)(nil), // 2: controller.api.resources.targets.v1.SessionAuthorizationData
}
var file_controller_servers_services_v1_session_service_proto_depIdxs = []int32{
	2, // 0: controller.servers.services.v1.GetSessionResponse.authorization:type_name -> controller.api.resources.targets.v1.SessionAuthorizationData
