...
// 	protoc        v3.11.4
// source: controller/api/resource/hosts/v1/host_catalog.proto
...
func (HostCatalogType) Descriptor() protoreflect.EnumDescriptor {
	return file_controller_api_resource_hosts_v1_host_catalog_proto_enumTypes[0].Descriptor()
}

func (HostCatalogType) Type() protoreflect.EnumType {
	return &file_controller_api_resource_hosts_v1_host_catalog_proto_enumTypes[0]
}
...
func (HostCatalogType) EnumDescriptor() ([]byte, []int) {
	return file_controller_api_resource_hosts_v1_host_catalog_proto_rawDescGZIP(), []int{0}
}
...
type HostCatalog struct {
	...
	Type        HostCatalogType           `protobuf:"varint,8,opt,name=type,proto3,enum=controller.api.resource.hosts.v1.HostCatalogType" json:"type,omitempty"` // TODO: Figure out how to provide relevant information regarding Host and Set lists on a catalog.
}

func (x *HostCatalog) Reset() {
	*x = HostCatalog{}
	if protoimpl.UnsafeEnabled {
		mi := &file_controller_api_resource_hosts_v1_host_catalog_proto_msgTypes[0]
...
func (x *HostCatalog) GetPath() string {
	if x != nil {
		return x.Path
	}
	return ""
...
func (x *StaticCatalogDetails) Reset() {
	*x = StaticCatalogDetails{}
	if protoimpl.UnsafeEnabled {
		mi := &file_controller_api_resource_hosts_v1_host_catalog_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*StaticCatalogDetails) Descriptor() ([]byte, []int) {
	return file_controller_api_resource_hosts_v1_host_catalog_proto_rawDescGZIP(), []int{1}
}
...
func (x *Ec2CatalogDetails) Reset() {
	*x = Ec2CatalogDetails{}
	if protoimpl.UnsafeEnabled {
		mi := &file_controller_api_resource_hosts_v1_host_catalog_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Ec2CatalogDetails) Descriptor() ([]byte, []int) {
	return file_controller_api_resource_hosts_v1_host_catalog_proto_rawDescGZIP(), []int{2}
}
...
var File_controller_api_resource_hosts_v1_host_catalog_proto protoreflect.FileDescriptor

var file_controller_api_resource_hosts_v1_host_catalog_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	0x2e, 0x76, 0x31, 0x2e, 0x45, 0x63, 0x32, 0x43, 0x61, 0x74, 0x61, 0x6c, 0x6f, 0x67, 0x44, 0x65,
	0x74, 0x61, 0x69, 0x6c, 0x73, 0x48, 0x00, 0x52, 0x15, 0x65, 0x63, 0x32, 0x48, 0x6f, 0x73, 0x74,
	0x43, 0x61, 0x74, 0x61, 0x6c, 0x6f, 0x67, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x12, 0x45,
	0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x31, 0x2e, 0x63,
	...
	0x45, 0x5f, 0x53, 0x54, 0x41, 0x54, 0x49, 0x43, 0x10, 0x02, 0x42, 0x52, 0x5a, 0x50, 0x67, 0x69,
	...
	0x63, 0x65, 0x2f, 0x68, 0x6f, 0x73, 0x74, 0x73, 0x3b, 0x68, 0x6f, 0x73, 0x74, 0x73, 0x62, 0x06,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_controller_api_resource_hosts_v1_host_catalog_proto_rawDescOnce sync.Once
	file_controller_api_resource_hosts_v1_host_catalog_proto_rawDescData = file_controller_api_resource_hosts_v1_host_catalog_proto_rawDesc
)

func file_controller_api_resource_hosts_v1_host_catalog_proto_rawDescGZIP() []byte {
	file_controller_api_resource_hosts_v1_host_catalog_proto_rawDescOnce.Do(func() {
		file_controller_api_resource_hosts_v1_host_catalog_proto_rawDescData = protoimpl.X.CompressGZIP(file_controller_api_resource_hosts_v1_host_catalog_proto_rawDescData)
	})
	return file_controller_api_resource_hosts_v1_host_catalog_proto_rawDescData
}

var file_controller_api_resource_hosts_v1_host_catalog_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_controller_api_resource_hosts_v1_host_catalog_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_controller_api_resource_hosts_v1_host_catalog_proto_goTypes = []interface{}{
	(HostCatalogType)(0),         // 0: controller.api.resource.hosts.v1.HostCatalogType
	(*HostCatalog)(nil),          // 1: controller.api.resource.hosts.v1.HostCatalog
	(*StaticCatalogDetails)(nil), // 2: controller.api.resource.hosts.v1.StaticCatalogDetails
	(*Ec2CatalogDetails)(nil),    // 3: controller.api.resource.hosts.v1.Ec2CatalogDetails
	(*wrappers.StringValue)(nil), // 4: google.protobuf.StringValue
	(*timestamp.Timestamp)(nil),  // 5: google.protobuf.Timestamp
	(*wrappers.BoolValue)(nil),   // 6: google.protobuf.BoolValue
}
var file_controller_api_resource_hosts_v1_host_catalog_proto_depIdxs = []int32{
	4,  // 0: controller.api.resource.hosts.v1.HostCatalog.friendly_name:type_name -> google.protobuf.StringValue
	5,  // 1: controller.api.resource.hosts.v1.HostCatalog.created_time:type_name -> google.protobuf.Timestamp
	5,  // 2: controller.api.resource.hosts.v1.HostCatalog.updated_time:type_name -> google.protobuf.Timestamp
	6,  // 3: controller.api.resource.hosts.v1.HostCatalog.disabled:type_name -> google.protobuf.BoolValue
	2,  // 4: controller.api.resource.hosts.v1.HostCatalog.static_host_catalog_details:type_name -> controller.api.resource.hosts.v1.StaticCatalogDetails
	3,  // 5: controller.api.resource.hosts.v1.HostCatalog.ec2_host_catalog_details:type_name -> controller.api.resource.hosts.v1.Ec2CatalogDetails
	0,  // 6: controller.api.resource.hosts.v1.HostCatalog.type:type_name -> controller.api.resource.hosts.v1.HostCatalogType
	4,  // 7: controller.api.resource.hosts.v1.Ec2CatalogDetails.access_key:type_name -> google.protobuf.StringValue
	4,  // 8: controller.api.resource.hosts.v1.Ec2CatalogDetails.secret_key:type_name -> google.protobuf.StringValue
	6,  // 9: controller.api.resource.hosts.v1.Ec2CatalogDetails.rotate:type_name -> google.protobuf.BoolValue
...
func init() { file_controller_api_resource_hosts_v1_host_catalog_proto_init() }
func file_controller_api_resource_hosts_v1_host_catalog_proto_init() {
	if File_controller_api_resource_hosts_v1_host_catalog_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_controller_api_resource_hosts_v1_host_catalog_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_controller_api_resource_hosts_v1_host_catalog_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_controller_api_resource_hosts_v1_host_catalog_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	file_controller_api_resource_hosts_v1_host_catalog_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_controller_api_resource_hosts_v1_host_catalog_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_controller_api_resource_hosts_v1_host_catalog_proto_goTypes,
		DependencyIndexes: file_controller_api_resource_hosts_v1_host_catalog_proto_depIdxs,
		EnumInfos:         file_controller_api_resource_hosts_v1_host_catalog_proto_enumTypes,
		MessageInfos:      file_controller_api_resource_hosts_v1_host_catalog_proto_msgTypes,
	}.Build()
	File_controller_api_resource_hosts_v1_host_catalog_proto = out.File
	file_controller_api_resource_hosts_v1_host_catalog_proto_rawDesc = nil
	file_controller_api_resource_hosts_v1_host_catalog_proto_goTypes = nil
	file_controller_api_resource_hosts_v1_host_catalog_proto_depIdxs = nil
}
