...
func file_controller_api_v1_error_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_controller_api_v1_error_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_controller_api_v1_error_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_controller_api_v1_error_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_controller_api_v1_error_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch v := v.(*Error); i {
			case 0:
				return &v.state
			case 1:
