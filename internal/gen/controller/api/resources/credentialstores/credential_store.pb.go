...
type VaultCredentialStoreAttributes struct {
	...
	VaultAddress *wrapperspb.StringValue `protobuf:"bytes,10,opt,name=vault_address,proto3" json:"vault_address,omitempty"`
	// The namespace of vault used by this store
	VaultNamespace *wrapperspb.StringValue `protobuf:"bytes,20,opt,name=vault_namespace,proto3" json:"vault_namespace,omitempty"`
	...
	VaultTlsServerName *wrapperspb.StringValue `protobuf:"bytes,40,opt,name=vault_tls_server_name,proto3" json:"vault_tls_server_name,omitempty"`
	// When set to true verification of the TLS certificate is disabled.
	VaultTlsSkipVerify *wrapperspb.BoolValue `protobuf:"bytes,50,opt,name=vault_tls_skip_verify,proto3" json:"vault_tls_skip_verify,omitempty"`
	// Input only field. The current vault token used by this credential store for creating new credentials.
	VaultToken *wrapperspb.StringValue `protobuf:"bytes,60,opt,name=vault_token,proto3" json:"vault_token,omitempty"`
	...
	// field.
	VaultClientCertificate *wrapperspb.StringValue `protobuf:"bytes,80,opt,name=vault_client_certificate,proto3" json:"vault_client_certificate,omitempty"`
	// Input only field. A client certificate private key.
	VaultClientCertificateKey *wrapperspb.StringValue `protobuf:"bytes,90,opt,name=vault_client_certificate_key,proto3" json:"vault_client_certificate_key,omitempty"`
	// Output only field. The hmac value of the private key used by the credential store.
	VaultClientCertificateKeyHmac string `protobuf:"bytes,100,opt,name=vault_client_certificate_key_hmac,proto3" json:"vault_client_certificate_key_hmac,omitempty"`
}
...
func (x *VaultCredentialStoreAttributes) GetVaultAddress() *wrapperspb.StringValue {
	if x != nil {
...
func (x *VaultCredentialStoreAttributes) GetVaultNamespace() *wrapperspb.StringValue {
	if x != nil {
...
func (x *VaultCredentialStoreAttributes) GetVaultTlsServerName() *wrapperspb.StringValue {
	if x != nil {
		return x.VaultTlsServerName
	}
	return nil
}

func (x *VaultCredentialStoreAttributes) GetVaultTlsSkipVerify() *wrapperspb.BoolValue {
	if x != nil {
		return x.VaultTlsSkipVerify
	}
	return nil
}

func (x *VaultCredentialStoreAttributes) GetVaultToken() *wrapperspb.StringValue {
	if x != nil {
		return x.VaultToken
	}
	return nil
...
func (x *VaultCredentialStoreAttributes) GetVaultClientCertificate() *wrapperspb.StringValue {
	if x != nil {
		return x.VaultClientCertificate
	}
	return nil
}

func (x *VaultCredentialStoreAttributes) GetVaultClientCertificateKey() *wrapperspb.StringValue {
	if x != nil {
		return x.VaultClientCertificateKey
	}
	return nil
}

func (x *VaultCredentialStoreAttributes) GetVaultClientCertificateKeyHmac() string {
	if x != nil {
		return x.VaultClientCertificateKeyHmac
	}
	return ""
}
...
var file_controller_api_resources_credentialstores_v1_credential_store_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	,
	...
	0x63, 0x42, 0x67, 0x5a, 0x65, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f,
	...
	0x69, 0x61, 0x6c, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x73, 0x3b, 0x63, 0x72, 0x65, 0x64, 0x65, 0x6e,
	0x74, 0x69, 0x61, 0x6c, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x73, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
...
var file_controller_api_resources_credentialstores_v1_credential_store_proto_depIdxs = []int32{
	...
	4,  // 7: controller.api.resources.credentialstores.v1.VaultCredentialStoreAttributes.vault_address:type_name -> google.protobuf.StringValue
	4,  // 8: controller.api.resources.credentialstores.v1.VaultCredentialStoreAttributes.vault_namespace:type_name -> google.protobuf.StringValue
	4,  // 9: controller.api.resources.credentialstores.v1.VaultCredentialStoreAttributes.vault_ca_cert:type_name -> google.protobuf.StringValue
	4,  // 10: controller.api.resources.credentialstores.v1.VaultCredentialStoreAttributes.vault_tls_server_name:type_name -> google.protobuf.StringValue
	7,  // 11: controller.api.resources.credentialstores.v1.VaultCredentialStoreAttributes.vault_tls_skip_verify:type_name -> google.protobuf.BoolValue
	4,  // 12: controller.api.resources.credentialstores.v1.VaultCredentialStoreAttributes.vault_token:type_name -> google.protobuf.StringValue
	4,  // 13: controller.api.resources.credentialstores.v1.VaultCredentialStoreAttributes.vault_client_certificate:type_name -> google.protobuf.StringValue
	4,  // 14: controller.api.resources.credentialstores.v1.VaultCredentialStoreAttributes.vault_client_certificate_key:type_name -> google.protobuf.StringValue
