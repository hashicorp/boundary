...
var file_controller_api_resources_hosts_v1_host_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0xf9, 0x02, 0x0a, 0x04, 0x48, 0x6f, 0x73, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x69,
	...
	0x56, 0x61, 0x6c, 0x75, 0x65, 0x52, 0x07, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x42, 0x53,
...
var file_controller_api_resources_hosts_v1_host_proto_depIdxs = []int32{
	...
	1, // 1: controller.api.resources.hosts.v1.Host.friendly_name:type_name -> google.protobuf.StringValue
	2, // 2: controller.api.resources.hosts.v1.Host.created_time:type_name -> google.protobuf.Timestamp
	2, // 3: controller.api.resources.hosts.v1.Host.updated_time:type_name -> google.protobuf.Timestamp
	3, // 4: controller.api.resources.hosts.v1.Host.disabled:type_name -> google.protobuf.BoolValue
	1, // 5: controller.api.resources.hosts.v1.Host.address:type_name -> google.protobuf.StringValue
