...
type HostSet struct {
	...
	// Output only.
	Size uint32 `protobuf:"varint,90,opt,name=size,proto3" json:"size,omitempty"`
	...
	// Output only.
	Hosts []*Host `protobuf:"bytes,100,rep,name=hosts,proto3" json:"hosts,omitempty"`
}
...
var file_controller_api_resources_hosts_v1_host_set_proto_goTypes = []interface{}{
	...
	(*Host)(nil),                 // 4: controller.api.resources.hosts.v1.Host
}
var file_controller_api_resources_hosts_v1_host_set_proto_depIdxs = []int32{
	...
	2, // 5: controller.api.resources.hosts.v1.HostSet.type:type_name -> google.protobuf.StringValue
	4, // 6: controller.api.resources.hosts.v1.HostSet.hosts:type_name -> controller.api.resources.hosts.v1.Host
