...
type User struct {
	...
	LoginName *wrapperspb.StringValue `protobuf:"bytes,110,opt,name=login_name,proto3" json:"login_name,omitempty"`
	// Output only. full_name is a string that maps to the user's account name
	// from the scope's primary auth method
	FullName *wrapperspb.StringValue `protobuf:"bytes,120,opt,name=full_name,proto3" json:"full_name,omitempty"`
	// Output only. email is a string that maps to the user's account email from
	// the scope's primary auth method
	Email *wrapperspb.StringValue `protobuf:"bytes,130,opt,name=email,proto3" json:"email,omitempty"`
	// Output only. primary_account_id is a string that maps to the user's account
	// public_id from the scope's primary auth method
	PrimaryAccountId *wrapperspb.StringValue `protobuf:"bytes,140,opt,name=primary_account_id,proto3" json:"primary_account_id,omitempty"`
}
...
func (x *User) GetLoginName() *wrapperspb.StringValue {
	if x != nil {
		return x.LoginName
	}
	return nil
...
func (x *User) GetPrimaryAccountId() *wrapperspb.StringValue {
	if x != nil {
