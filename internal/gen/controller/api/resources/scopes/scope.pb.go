...
var file_controller_api_resources_scopes_v1_scope_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xc1, 0x02, 0x0a, 0x05, 0x53, 0x63, 0x6f, 0x70, 0x65, 0x12,
...
var file_controller_api_resources_scopes_v1_scope_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_controller_api_resources_scopes_v1_scope_proto_goTypes = []interface{}{
	(*Scope)(nil),                // 0: controller.api.resources.scopes.v1.Scope
...
var file_controller_api_resources_scopes_v1_scope_proto_depIdxs = []int32{
	1, // 0: controller.api.resources.scopes.v1.Scope.name:type_name -> google.protobuf.StringValue
	1, // 1: controller.api.resources.scopes.v1.Scope.description:type_name -> google.protobuf.StringValue
	2, // 2: controller.api.resources.scopes.v1.Scope.created_time:type_name -> google.protobuf.Timestamp
	2, // 3: controller.api.resources.scopes.v1.Scope.updated_time:type_name -> google.protobuf.Timestamp
	3, // 4: controller.api.resources.scopes.v1.Scope.disabled:type_name -> google.protobuf.BoolValue
