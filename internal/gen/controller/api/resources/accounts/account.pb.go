...
type OidcAccountAttributes struct {
	...
	IssuerId string `protobuf:"bytes,80,opt,name=issuer_id,proto3" json:"issuer_id,omitempty"`
	// Output only. subject_id is a case sensitive string that maps to the OIDC sub claim.
	SubjectId string `protobuf:"bytes,90,opt,name=subject_id,proto3" json:"subject_id,omitempty"`
...
func (x *OidcAccountAttributes) GetIssuerId() string {
	if x != nil {
		return x.IssuerId
	}
	return ""
...
func (x *OidcAccountAttributes) GetSubjectId() string {
	if x != nil {
		return x.SubjectId
	}
	return ""
...
var file_controller_api_resources_accounts_v1_account_proto_rawDesc = []byte{
	...
	,
