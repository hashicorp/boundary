...
type OidcAccountAttributes struct {
	...
	IssuerId string `protobuf:"bytes,80,opt,name=issuer_id,json=issuerId,proto3" json:"issuer_id,omitempty"`
	// Output only. subject_id is a case sensitive string that maps to the OIDC sub claim.
	SubjectId string `protobuf:"bytes,90,opt,name=subject_id,json=subjectId,proto3" json:"subject_id,omitempty"`
	// full_name is a string that maps to the OIDC name claim
	FullName string `protobuf:"bytes,100,opt,name=full_name,json=fullName,proto3" json:"full_name,omitempty"`
...
var file_controller_api_resources_accounts_v1_account_proto_rawDesc = []byte{
	...
	0x72, 0x64, 0x22, 0x86, 0x01, 0x0a, 0x15, 0x4f, 0x69, 0x64, 0x63, 0x41, 0x63, 0x63, 0x6f, 0x75,
	...
	0x08, 0x69, 0x73, 0x73, 0x75, 0x65, 0x72, 0x49, 0x64, 0x12, 0x1d, 0x0a, 0x0a, 0x73, 0x75, 0x62,
	0x6a, 0x65, 0x63, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x5a, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x73,
	0x75, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x49, 0x64, 0x12, 0x1b, 0x0a, 0x09, 0x66, 0x75, 0x6c, 0x6c,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x42, 0x57, 0x5a, 0x55, 0x67,
