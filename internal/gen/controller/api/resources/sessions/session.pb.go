...
type Session struct {
	...
	Certificate []byte `protobuf:"bytes,110,opt,name=certificate,proto3" json:"certificate,omitempty"`
	// The private key to use when connecting (or if using custom certs, to pass
	// as the "password").
	PrivateKey []byte `protobuf:"bytes,120,opt,name=private_key,proto3" json:"private_key,omitempty"`
	// Worker information. The first worker in the slice should be prioritized.
	WorkerInfo []*WorkerInfo `protobuf:"bytes,140,rep,name=worker_info,proto3" json:"worker_info,omitempty"`
}
...
var file_controller_api_resources_sessions_v1_session_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x22, 0xbd, 0x04,
	...
	0x74, 0x5f, 0x69, 0x64, 0x12, 0x20, 0x0a, 0x0b, 0x63, 0x65, 0x72, 0x74, 0x69, 0x66, 0x69, 0x63,
	0x61, 0x74, 0x65, 0x18, 0x6e, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0b, 0x63, 0x65, 0x72, 0x74, 0x69,
	0x66, 0x69, 0x63, 0x61, 0x74, 0x65, 0x12, 0x20, 0x0a, 0x0b, 0x70, 0x72, 0x69, 0x76, 0x61, 0x74,
	0x65, 0x5f, 0x6b, 0x65, 0x79, 0x18, 0x78, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0b, 0x70, 0x72, 0x69,
	0x76, 0x61, 0x74, 0x65, 0x5f, 0x6b, 0x65, 0x79, 0x12, 0x53, 0x0a, 0x0b, 0x77, 0x6f, 0x72, 0x6b,
	0x65, 0x72, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x8c, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x30,
