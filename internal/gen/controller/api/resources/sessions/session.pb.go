...
type SessionCreds struct {
	...
	// Contains the credentials that connecting results in
	...
	ExpirationTime *timestamp.Timestamp `protobuf:"bytes,30,opt,name=expiration_time,proto3" json:"expiration_time,omitempty"`
	...
	Certificate []byte `protobuf:"bytes,50,opt,name=certificate,proto3" json:"certificate,omitempty"`
	// The private key to use when connecting (or if using custom certs, to pass
	// as the "password").
	PrivateKey []byte `protobuf:"bytes,60,opt,name=private_key,proto3" json:"private_key,omitempty"`
...
func (x *SessionCreds) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SessionCreds) ProtoMessage() {}

func (x *SessionCreds) ProtoReflect() protoreflect.Message {
	mi := &file_controller_api_resources_sessions_v1_session_proto_msgTypes[0]
...
// Deprecated: Use SessionCreds.ProtoReflect.Descriptor instead.
func (*SessionCreds) Descriptor() ([]byte, []int) {
	return file_controller_api_resources_sessions_v1_session_proto_rawDescGZIP(), []int{0}
}

func (x *SessionCreds) GetSessionId() string {
	if x != nil {
		return x.SessionId
	}
	return ""
...
func (x *SessionCreds) GetTargetId() string {
	if x != nil {
		return x.TargetId
	}
	return ""
...
func (x *SessionCreds) GetExpirationTime() *timestamp.Timestamp {
	if x != nil {
...
func (x *SessionCreds) GetType() string {
	if x != nil {
		return x.Type
	}
	return ""
...
func (x *SessionCreds) GetCertificate() []byte {
	if x != nil {
...
func (x *SessionCreds) GetPrivateKey() []byte {
	if x != nil {
		return x.PrivateKey
	}
	return nil
...
func (x *SessionCreds) GetWorkerInfo() []*WorkerInfo {
	if x != nil {
		return x.WorkerInfo
	}
	return nil
...
type Session struct {
	...
	HostId   string `protobuf:"bytes,110,opt,name=host_id,proto3" json:"host_id,omitempty"`
	ScopeId  string `protobuf:"bytes,120,opt,name=scope_id,proto3" json:"scope_id,omitempty"`
	Endpoint string `protobuf:"bytes,150,opt,name=endpoint,proto3" json:"endpoint,omitempty"`
	// Worker information. The first worker in the slice should be prioritized.
	WorkerInfo []*WorkerInfo `protobuf:"bytes,160,rep,name=worker_info,proto3" json:"worker_info,omitempty"`
}
...
var file_controller_api_resources_sessions_v1_session_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xbd, 0x02, 0x0a, 0x0c, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f,
	0x6e, 0x43, 0x72, 0x65, 0x64, 0x73, 0x12, 0x1d, 0x0a, 0x0a, 0x73, 0x65, 0x73, 0x73, 0x69, 0x6f,
	...
	0x69, 0x64, 0x18, 0x14, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74,
	0x49, 0x64, 0x12, 0x44, 0x0a, 0x0f, 0x65, 0x78, 0x70, 0x69, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	...
	,
	...
	,
	...
	0x6b, 0x65, 0x72, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x42, 0x57, 0x5a, 0x55, 0x67, 0x69, 0x74, 0x68,
	...
	0x73, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x3b, 0x73, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e,
...
var file_controller_api_resources_sessions_v1_session_proto_goTypes = []interface{}{
	(*SessionCreds)(nil),        // 0: controller.api.resources.sessions.v1.SessionCreds
	(*WorkerInfo)(nil),          // 1: controller.api.resources.sessions.v1.WorkerInfo
...
var file_controller_api_resources_sessions_v1_session_proto_depIdxs = []int32{
	3, // 0: controller.api.resources.sessions.v1.SessionCreds.expiration_time:type_name -> google.protobuf.Timestamp
	1, // 1: controller.api.resources.sessions.v1.SessionCreds.worker_info:type_name -> controller.api.resources.sessions.v1.WorkerInfo
	...
	1, // 6: controller.api.resources.sessions.v1.Session.worker_info:type_name -> controller.api.resources.sessions.v1.WorkerInfo
