...
type Target struct {
	...
	Hosts []*hosts.HostSet `protobuf:"bytes,6,rep,name=hosts,proto3" json:"hosts,omitempty"`
...
func (x *Target) GetHosts() []*hosts.HostSet {
	if x != nil {
		return x.Hosts
	}
	return nil
...
var file_controller_api_resources_targets_v1_target_proto_rawDesc = []byte{
	...
	0x72, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x30, 0x63, 0x6f, 0x6e, 0x74, 0x72, 0x6f,
	0x6c, 0x6c, 0x65, 0x72, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63,
	0x65, 0x73, 0x2f, 0x68, 0x6f, 0x73, 0x74, 0x73, 0x2f, 0x76, 0x31, 0x2f, 0x68, 0x6f, 0x73, 0x74,
	0x5f, 0x73, 0x65, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x95, 0x03, 0x0a, 0x06, 0x54,
	0x61, 0x72, 0x67, 0x65, 0x74, 0x12, 0x10, 0x0a, 0x03, 0x75, 0x72, 0x69, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x03, 0x75, 0x72, 0x69, 0x12, 0x41, 0x0a, 0x0d, 0x66, 0x72, 0x69, 0x65, 0x6e,
	...
	0x12, 0x40, 0x0a, 0x05, 0x68, 0x6f, 0x73, 0x74, 0x73, 0x18, 0x06, 0x20, 0x03, 0x28, 0x0b, 0x32,
	...
	0x72, 0x74, 0x42, 0x57, 0x5a, 0x55, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d,
...
var file_controller_api_resources_targets_v1_target_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_controller_api_resources_targets_v1_target_proto_goTypes = []interface{}{
	(*Target)(nil),               // 0: controller.api.resources.targets.v1.Target
	(*wrappers.StringValue)(nil), // 1: google.protobuf.StringValue
	(*timestamp.Timestamp)(nil),  // 2: google.protobuf.Timestamp
	(*wrappers.BoolValue)(nil),   // 3: google.protobuf.BoolValue
	(*hosts.HostSet)(nil),        // 4: controller.api.resources.hosts.v1.HostSet
...
var file_controller_api_resources_targets_v1_target_proto_depIdxs = []int32{
	1, // 0: controller.api.resources.targets.v1.Target.friendly_name:type_name -> google.protobuf.StringValue
	2, // 1: controller.api.resources.targets.v1.Target.created_time:type_name -> google.protobuf.Timestamp
	2, // 2: controller.api.resources.targets.v1.Target.updated_time:type_name -> google.protobuf.Timestamp
	3, // 3: controller.api.resources.targets.v1.Target.disabled:type_name -> google.protobuf.BoolValue
	4, // 4: controller.api.resources.targets.v1.Target.hosts:type_name -> controller.api.resources.hosts.v1.HostSet
	5, // 5: controller.api.resources.targets.v1.Target.default_port:type_name -> google.protobuf.Int32Value
