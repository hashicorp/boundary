...
type Role struct {
	...
	// Output only.
	CanonicalGrants []string `protobuf:"bytes,12,rep,name=canonical_grants,json=canonicalGrants,proto3" json:"canonical_grants,omitempty"`
}
...
func (x *Role) GetCanonicalGrants() []string {
	if x != nil {
		return x.CanonicalGrants
	}
	return nil
}
...
var file_controller_api_resources_roles_v1_role_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0x9b, 0x04, 0x0a, 0x04, 0x52, 0x6f, 0x6c, 0x65, 0x12, 0x0e, 0x0a, 0x02, 0x69,
	...
	0x72, 0x61, 0x6e, 0x74, 0x73, 0x12, 0x29, 0x0a, 0x10, 0x63, 0x61, 0x6e, 0x6f, 0x6e, 0x69, 0x63,
	0x61, 0x6c, 0x5f, 0x67, 0x72, 0x61, 0x6e, 0x74, 0x73, 0x18, 0x0c, 0x20, 0x03, 0x28, 0x09, 0x52,
	0x0f, 0x63, 0x61, 0x6e, 0x6f, 0x6e, 0x69, 0x63, 0x61, 0x6c, 0x47, 0x72, 0x61, 0x6e, 0x74, 0x73,
