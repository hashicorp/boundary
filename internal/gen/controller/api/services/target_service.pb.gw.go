...
func request_TargetService_SetTargetStaticAddress_0(ctx context.Context, marshaler runtime.Marshaler, client TargetServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq SetTargetStaticAddressRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.SetTargetStaticAddress(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_TargetService_SetTargetStaticAddress_0(ctx context.Context, marshaler runtime.Marshaler, server TargetServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq SetTargetStaticAddressRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.SetTargetStaticAddress(ctx, &protoReq)
	return msg, metadata, err

}

func request_TargetService_RemoveTargetStaticAddress_0(ctx context.Context, marshaler runtime.Marshaler, client TargetServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq RemoveTargetStaticAddressRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.RemoveTargetStaticAddress(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_TargetService_RemoveTargetStaticAddress_0(ctx context.Context, marshaler runtime.Marshaler, server TargetServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq RemoveTargetStaticAddressRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.RemoveTargetStaticAddress(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterTargetServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server TargetServiceServer) error {
	...
	mux.Handle("POST", pattern_TargetService_SetTargetStaticAddress_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/controller.api.services.v1.TargetService/SetTargetStaticAddress", runtime.WithHTTPPathPattern("/v1/targets/{id}:set-static-address"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_TargetService_SetTargetStaticAddress_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_TargetService_SetTargetStaticAddress_0(annotatedContext, mux, outboundMarshaler, w, req, response_TargetService_SetTargetStaticAddress_0{resp}, mux.GetForwardResponseOptions()...)

	})

	mux.Handle("POST", pattern_TargetService_RemoveTargetStaticAddress_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/controller.api.services.v1.TargetService/RemoveTargetStaticAddress", runtime.WithHTTPPathPattern("/v1/targets/{id}:remove-static-address"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_TargetService_RemoveTargetStaticAddress_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_TargetService_RemoveTargetStaticAddress_0(annotatedContext, mux, outboundMarshaler, w, req, response_TargetService_RemoveTargetStaticAddress_0{resp}, mux.GetForwardResponseOptions()...)
...
func RegisterTargetServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client TargetServiceClient) error {
	...
	mux.Handle("POST", pattern_TargetService_SetTargetStaticAddress_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/controller.api.services.v1.TargetService/SetTargetStaticAddress", runtime.WithHTTPPathPattern("/v1/targets/{id}:set-static-address"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_TargetService_SetTargetStaticAddress_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("POST", pattern_TargetService_RemoveTargetStaticAddress_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/controller.api.services.v1.TargetService/RemoveTargetStaticAddress", runtime.WithHTTPPathPattern("/v1/targets/{id}:remove-static-address"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_TargetService_RemoveTargetStaticAddress_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
type response_TargetService_SetTargetStaticAddress_0 struct {
	proto.Message
}

func (m response_TargetService_SetTargetStaticAddress_0) XXX_ResponseBody() interface{} {
	response := m.Message.(*SetTargetStaticAddressResponse)
	return response.Item
}

type response_TargetService_RemoveTargetStaticAddress_0 struct {
	proto.Message
}

func (m response_TargetService_RemoveTargetStaticAddress_0) XXX_ResponseBody() interface{} {
	response := m.Message.(*RemoveTargetStaticAddressResponse)
	return response.Item
}
...
var (
	...
	pattern_TargetService_SetTargetStaticAddress_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"v1", "targets", "id"}, "set-static-address"))

	pattern_TargetService_RemoveTargetStaticAddress_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"v1", "targets", "id"}, "remove-static-address"))
)
...
var (
	...
	forward_TargetService_SetTargetStaticAddress_0 = runtime.ForwardResponseMessage

	forward_TargetService_RemoveTargetStaticAddress_0 = runtime.ForwardResponseMessage
)
