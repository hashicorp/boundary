...
var (
	filter_AuthMethodService_GetAuthMethod_0 = &utilities.DoubleArray{Encoding: map[string]int{"id": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
)
...
func request_AuthMethodService_GetAuthMethod_0(ctx context.Context, marshaler runtime.Marshaler, client AuthMethodServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_AuthMethodService_GetAuthMethod_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
var (
	filter_AuthMethodService_GetAuthMethod_1 = &utilities.DoubleArray{Encoding: map[string]int{"id": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
)

func request_AuthMethodService_GetAuthMethod_1(ctx context.Context, marshaler runtime.Marshaler, client AuthMethodServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetAuthMethodRequest
	var metadata runtime.ServerMetadata
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_AuthMethodService_GetAuthMethod_1); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
func local_request_AuthMethodService_GetAuthMethod_1(ctx context.Context, marshaler runtime.Marshaler, server AuthMethodServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetAuthMethodRequest
	var metadata runtime.ServerMetadata
...
var (
	filter_AuthMethodService_ListAuthMethods_1 = &utilities.DoubleArray{Encoding: map[string]int{"scope_id": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
)
...
func request_AuthMethodService_CreateAuthMethod_1(ctx context.Context, marshaler runtime.Marshaler, client AuthMethodServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq CreateAuthMethodRequest
	var metadata runtime.ServerMetadata
...
func local_request_AuthMethodService_CreateAuthMethod_1(ctx context.Context, marshaler runtime.Marshaler, server AuthMethodServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq CreateAuthMethodRequest
	var metadata runtime.ServerMetadata
...
var (
	filter_AuthMethodService_UpdateAuthMethod_1 = &utilities.DoubleArray{Encoding: map[string]int{"item": 0, "id": 1}, Base: []int{1, 1, 2, 0, 0}, Check: []int{0, 1, 1, 2, 3}}
)

func request_AuthMethodService_UpdateAuthMethod_1(ctx context.Context, marshaler runtime.Marshaler, client AuthMethodServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq UpdateAuthMethodRequest
	var metadata runtime.ServerMetadata
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_AuthMethodService_UpdateAuthMethod_1); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
func local_request_AuthMethodService_UpdateAuthMethod_1(ctx context.Context, marshaler runtime.Marshaler, server AuthMethodServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq UpdateAuthMethodRequest
	var metadata runtime.ServerMetadata
...
func request_AuthMethodService_DeleteAuthMethod_1(ctx context.Context, marshaler runtime.Marshaler, client AuthMethodServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq DeleteAuthMethodRequest
	var metadata runtime.ServerMetadata
...
func local_request_AuthMethodService_DeleteAuthMethod_1(ctx context.Context, marshaler runtime.Marshaler, server AuthMethodServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq DeleteAuthMethodRequest
	var metadata runtime.ServerMetadata
...
func RegisterAuthMethodServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server AuthMethodServiceServer) error {
	...
	mux.Handle("GET", pattern_AuthMethodService_GetAuthMethod_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/controller.api.services.v1.AuthMethodService/GetAuthMethod")
		...
		resp, md, err := local_request_AuthMethodService_GetAuthMethod_1(rctx, inboundMarshaler, server, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_AuthMethodService_GetAuthMethod_1(ctx, mux, outboundMarshaler, w, req, response_AuthMethodService_GetAuthMethod_1{resp}, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("POST", pattern_AuthMethodService_CreateAuthMethod_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/controller.api.services.v1.AuthMethodService/CreateAuthMethod")
		...
		resp, md, err := local_request_AuthMethodService_CreateAuthMethod_1(rctx, inboundMarshaler, server, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_AuthMethodService_CreateAuthMethod_1(ctx, mux, outboundMarshaler, w, req, response_AuthMethodService_CreateAuthMethod_1{resp}, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("PATCH", pattern_AuthMethodService_UpdateAuthMethod_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/controller.api.services.v1.AuthMethodService/UpdateAuthMethod")
		...
		resp, md, err := local_request_AuthMethodService_UpdateAuthMethod_1(rctx, inboundMarshaler, server, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_AuthMethodService_UpdateAuthMethod_1(ctx, mux, outboundMarshaler, w, req, response_AuthMethodService_UpdateAuthMethod_1{resp}, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("DELETE", pattern_AuthMethodService_DeleteAuthMethod_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/controller.api.services.v1.AuthMethodService/DeleteAuthMethod")
		...
		resp, md, err := local_request_AuthMethodService_DeleteAuthMethod_1(rctx, inboundMarshaler, server, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_AuthMethodService_DeleteAuthMethod_1(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterAuthMethodServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client AuthMethodServiceClient) error {
	...
	mux.Handle("GET", pattern_AuthMethodService_GetAuthMethod_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_AuthMethodService_GetAuthMethod_1(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("POST", pattern_AuthMethodService_CreateAuthMethod_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_AuthMethodService_CreateAuthMethod_1(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("PATCH", pattern_AuthMethodService_UpdateAuthMethod_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_AuthMethodService_UpdateAuthMethod_1(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("DELETE", pattern_AuthMethodService_DeleteAuthMethod_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_AuthMethodService_DeleteAuthMethod_1(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
type response_AuthMethodService_GetAuthMethod_1 struct {
	proto.Message
}

func (m response_AuthMethodService_GetAuthMethod_1) XXX_ResponseBody() interface{} {
	response := m.Message.(*GetAuthMethodResponse)
	return response.Item
}
...
type response_AuthMethodService_CreateAuthMethod_1 struct {
	proto.Message
}

func (m response_AuthMethodService_CreateAuthMethod_1) XXX_ResponseBody() interface{} {
	response := m.Message.(*CreateAuthMethodResponse)
	return response.Item
}
...
type response_AuthMethodService_UpdateAuthMethod_1 struct {
	proto.Message
}

func (m response_AuthMethodService_UpdateAuthMethod_1) XXX_ResponseBody() interface{} {
	response := m.Message.(*UpdateAuthMethodResponse)
	return response.Item
}
...
var (
	...
	pattern_AuthMethodService_GetAuthMethod_1 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"v1", "scopes", "auth-methods", "id"}, ""))

	pattern_AuthMethodService_ListAuthMethods_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "auth-methods"}, ""))

	pattern_AuthMethodService_ListAuthMethods_1 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3}, []string{"v1", "scopes", "scope_id", "auth-methods"}, ""))

	pattern_AuthMethodService_CreateAuthMethod_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "auth-methods"}, ""))

	pattern_AuthMethodService_CreateAuthMethod_1 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3}, []string{"v1", "scopes", "item.scope_id", "auth-methods"}, ""))
	...
	pattern_AuthMethodService_UpdateAuthMethod_1 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"v1", "scopes", "auth-methods", "id"}, ""))
	...
	pattern_AuthMethodService_DeleteAuthMethod_1 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"v1", "scopes", "auth-methods", "id"}, ""))
)

var (
	forward_AuthMethodService_GetAuthMethod_0 = runtime.ForwardResponseMessage

	forward_AuthMethodService_GetAuthMethod_1 = runtime.ForwardResponseMessage
	...
	forward_AuthMethodService_CreateAuthMethod_1 = runtime.ForwardResponseMessage

	forward_AuthMethodService_UpdateAuthMethod_0 = runtime.ForwardResponseMessage

	forward_AuthMethodService_UpdateAuthMethod_1 = runtime.ForwardResponseMessage

	forward_AuthMethodService_DeleteAuthMethod_0 = runtime.ForwardResponseMessage

	forward_AuthMethodService_DeleteAuthMethod_1 = runtime.ForwardResponseMessage
)
