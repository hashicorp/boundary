...
type GetAccountResponse struct {
	...
	Item *accounts.Account `protobuf:"bytes,1,opt,name=item,proto3" json:"item,omitempty" class:"public"` // @gotags: `class:"public"`
}
...
type ListAccountsResponse struct {
	...
	Items []*accounts.Account `protobuf:"bytes,1,rep,name=items,proto3" json:"items,omitempty" class:"public"` // @gotags: `class:"public"`
}
...
type CreateAccountRequest struct {
	...
	Item *accounts.Account `protobuf:"bytes,2,opt,name=item,proto3" json:"item,omitempty" class:"public"` // @gotags: `class:"public"`
}
...
type UpdateAccountRequest struct {
	...
	Id         string                 `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty" class:"public"`                   // @gotags: `class:"public"`
	Item       *accounts.Account      `protobuf:"bytes,2,opt,name=item,proto3" json:"item,omitempty" class:"public"`               // @gotags: `class:"public"`
	UpdateMask *fieldmaskpb.FieldMask `protobuf:"bytes,3,opt,name=update_mask,proto3" json:"update_mask,omitempty" class:"public"` // @gotags: `class:"public"`
}
