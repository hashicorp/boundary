...
const (
	...
	ResourceType_RESOURCE_TYPE_TARGET             ResourceType = 1
	ResourceType_RESOURCE_TYPE_HOST               ResourceType = 2
	ResourceType_RESOURCE_TYPE_SESSION            ResourceType = 3
	ResourceType_RESOURCE_TYPE_SESSION_RECORDING  ResourceType = 4
	ResourceType_RESOURCE_TYPE_AUTH_TOKEN         ResourceType = 5
	ResourceType_RESOURCE_TYPE_ACCOUNT            ResourceType = 6
	ResourceType_RESOURCE_TYPE_CREDENTIAL_LIBRARY ResourceType = 7
	ResourceType_RESOURCE_TYPE_CREDENTIAL_STORE   ResourceType = 8
)
...
var (
	ResourceType_name = map[int32]string{
		...
		1: "RESOURCE_TYPE_TARGET",
		2: "RESOURCE_TYPE_HOST",
		3: "RESOURCE_TYPE_SESSION",
		4: "RESOURCE_TYPE_SESSION_RECORDING",
		5: "RESOURCE_TYPE_AUTH_TOKEN",
		6: "RESOURCE_TYPE_ACCOUNT",
		7: "RESOURCE_TYPE_CREDENTIAL_LIBRARY",
		8: "RESOURCE_TYPE_CREDENTIAL_STORE",
	}
	ResourceType_value = map[string]int32{
		...
		"RESOURCE_TYPE_AUTH_TOKEN":         5,
		"RESOURCE_TYPE_ACCOUNT":            6,
		"RESOURCE_TYPE_CREDENTIAL_LIBRARY": 7,
		"RESOURCE_TYPE_CREDENTIAL_STORE":   8,
	}
)
...
type ListRefreshToken struct {
	...
	ResourceType ResourceType `protobuf:"varint,20,opt,name=resource_type,json=resourceType,proto3,enum=controller.api.services.v1.ResourceType" json:"resource_type,omitempty"`
	// A hash of the users permissions
	// at the time of the refresh token issuing.
	PermissionsHash []byte `protobuf:"bytes,30,opt,name=permissions_hash,json=permissionsHash,proto3" json:"permissions_hash,omitempty"`
	// The ID of the last item returned on the
	// previous page.
	LastItemId string `protobuf:"bytes,40,opt,name=last_item_id,json=lastItemId,proto3" json:"last_item_id,omitempty"`
	...
	LastItemUpdatedTime *timestamppb.Timestamp `protobuf:"bytes,50,opt,name=last_item_updated_time,json=lastItemUpdatedTime,proto3" json:"last_item_updated_time,omitempty"`
}
...
func (x *ListRefreshToken) GetPermissionsHash() []byte {
	if x != nil {
		return x.PermissionsHash
	}
	return nil
}
...
var file_controller_api_services_v1_list_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0xbe, 0x02, 0x0a, 0x10, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x66,
	...
	0x61, 0x74, 0x65, 0x64, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x4d, 0x0a, 0x0d, 0x72, 0x65, 0x73, 0x6f,
	0x75, 0x72, 0x63, 0x65, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x14, 0x20, 0x01, 0x28, 0x0e, 0x32,
	...
	,
	...
	,
	...
	0x52, 0x41, 0x52, 0x59, 0x10, 0x07, 0x12, 0x22, 0x0a, 0x1e, 0x52, 0x45, 0x53, 0x4f, 0x55, 0x52,
	0x43, 0x45, 0x5f, 0x54, 0x59, 0x50, 0x45, 0x5f, 0x43, 0x52, 0x45, 0x44, 0x45, 0x4e, 0x54, 0x49,
	0x41, 0x4c, 0x5f, 0x53, 0x54, 0x4f, 0x52, 0x45, 0x10, 0x08, 0x42, 0x4d, 0x5a, 0x4b, 0x67, 0x69,
...
var file_controller_api_services_v1_list_proto_depIdxs = []int32{
	...
	0, // 1: controller.api.services.v1.ListRefreshToken.resource_type:type_name -> controller.api.services.v1.ResourceType
	2, // 2: controller.api.services.v1.ListRefreshToken.last_item_updated_time:type_name -> google.protobuf.Timestamp
