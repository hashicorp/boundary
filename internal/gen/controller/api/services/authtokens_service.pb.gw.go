...
var (
	filter_AuthTokenService_GetAuthToken_0 = &utilities.DoubleArray{Encoding: map[string]int{"id": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
)
...
func request_AuthTokenService_GetAuthToken_0(ctx context.Context, marshaler runtime.Marshaler, client AuthTokenServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_AuthTokenService_GetAuthToken_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
var (
	filter_AuthTokenService_GetAuthToken_1 = &utilities.DoubleArray{Encoding: map[string]int{"id": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
)

func request_AuthTokenService_GetAuthToken_1(ctx context.Context, marshaler runtime.Marshaler, client AuthTokenServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetAuthTokenRequest
	var metadata runtime.ServerMetadata
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_AuthTokenService_GetAuthToken_1); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
func local_request_AuthTokenService_GetAuthToken_1(ctx context.Context, marshaler runtime.Marshaler, server AuthTokenServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetAuthTokenRequest
	var metadata runtime.ServerMetadata
...
var (
	filter_AuthTokenService_ListAuthTokens_1 = &utilities.DoubleArray{Encoding: map[string]int{"scope_id": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
)
...
func request_AuthTokenService_DeleteAuthToken_1(ctx context.Context, marshaler runtime.Marshaler, client AuthTokenServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq DeleteAuthTokenRequest
	var metadata runtime.ServerMetadata
...
func local_request_AuthTokenService_DeleteAuthToken_1(ctx context.Context, marshaler runtime.Marshaler, server AuthTokenServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq DeleteAuthTokenRequest
	var metadata runtime.ServerMetadata
...
func RegisterAuthTokenServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server AuthTokenServiceServer) error {
	...
	mux.Handle("GET", pattern_AuthTokenService_GetAuthToken_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/controller.api.services.v1.AuthTokenService/GetAuthToken")
		...
		resp, md, err := local_request_AuthTokenService_GetAuthToken_1(rctx, inboundMarshaler, server, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_AuthTokenService_GetAuthToken_1(ctx, mux, outboundMarshaler, w, req, response_AuthTokenService_GetAuthToken_1{resp}, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("DELETE", pattern_AuthTokenService_DeleteAuthToken_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/controller.api.services.v1.AuthTokenService/DeleteAuthToken")
		...
		resp, md, err := local_request_AuthTokenService_DeleteAuthToken_1(rctx, inboundMarshaler, server, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_AuthTokenService_DeleteAuthToken_1(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterAuthTokenServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client AuthTokenServiceClient) error {
	...
	mux.Handle("GET", pattern_AuthTokenService_GetAuthToken_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_AuthTokenService_GetAuthToken_1(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("DELETE", pattern_AuthTokenService_DeleteAuthToken_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_AuthTokenService_DeleteAuthToken_1(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
type response_AuthTokenService_GetAuthToken_1 struct {
	proto.Message
}

func (m response_AuthTokenService_GetAuthToken_1) XXX_ResponseBody() interface{} {
	response := m.Message.(*GetAuthTokenResponse)
	return response.Item
}
...
var (
	...
	pattern_AuthTokenService_GetAuthToken_1 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"v1", "scopes", "auth-tokens", "id"}, ""))

	pattern_AuthTokenService_ListAuthTokens_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "auth-tokens"}, ""))

	pattern_AuthTokenService_ListAuthTokens_1 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3}, []string{"v1", "scopes", "scope_id", "auth-tokens"}, ""))
	...
	pattern_AuthTokenService_DeleteAuthToken_1 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"v1", "scopes", "auth-tokens", "id"}, ""))
)

var (
	forward_AuthTokenService_GetAuthToken_0 = runtime.ForwardResponseMessage

	forward_AuthTokenService_GetAuthToken_1 = runtime.ForwardResponseMessage
	...
	forward_AuthTokenService_DeleteAuthToken_1 = runtime.ForwardResponseMessage
)
