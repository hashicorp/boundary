...
type AddRolePrincipalsRequest struct {
	...
	PrincipalIds  []string `protobuf:"bytes,3,rep,name=principal_ids,proto3" json:"principal_ids,omitempty"` // @gotags: `class:"public" eventstream:"observation"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type AddRoleGrantsRequest struct {
	...
	// The mutation will fail if the version does not match the latest known good version.
	Version       uint32   `protobuf:"varint,2,opt,name=version,proto3" json:"version,omitempty"`            // @gotags: `class:"public"`
	GrantStrings  []string `protobuf:"bytes,3,rep,name=grant_strings,proto3" json:"grant_strings,omitempty"` // @gotags: `class:"public"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type AddRoleGrantScopesRequest struct {
	...
	// The mutation will fail if the version does not match the latest known good version.
	Version       uint32   `protobuf:"varint,2,opt,name=version,proto3" json:"version,omitempty"`                // @gotags: `class:"public"`
	GrantScopeIds []string `protobuf:"bytes,3,rep,name=grant_scope_ids,proto3" json:"grant_scope_ids,omitempty"` // @gotags: `class:"public"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
