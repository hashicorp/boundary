...
func file_ops_services_v1_health_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_ops_services_v1_health_service_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_ops_services_v1_health_service_proto_msgTypes[1].Exporter = func(v any, i int) any {
