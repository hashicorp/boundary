begin;
  ...
  create table session_target_address (
    ...
    constraint session_fkey foreign key (session_id)
        ...
        on delete cascade
        on update cascade,
    constraint session_id_target_id_uq
  ...
  create table session_host_set_host (
    ...
    constraint session_fkey foreign key (session_id)
        ...
        on delete cascade
        on update cascade,
    constraint session_id_host_set_id_host_id_uq
  ...
  create or replace function cancel_session_with_null_host_source_fk() returns trigger
  as $$
  begin
