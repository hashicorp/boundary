...
individual_org_grant_scopes as (
  ...
  select app_token_permission_global_individual_org_grant_scope.permission_id,
         app_token_permission_global_individual_org_grant_scope.scope_id
    from app_token_permission_global_individual_org_grant_scope
    join filtered_permissions
      on app_token_permission_global_individual_org_grant_scope.permission_id = filtered_permissions.private_id
   where app_token_permission_global_individual_org_grant_scope.scope_id = 'o__________10'
),
all_grant_scopes as (
...
select  all_grant_scopes.private_id as permission_id,
 ...
 where all_grant_scopes.grant_scope in ('children', 'individual')
