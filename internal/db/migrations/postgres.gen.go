...
`),
	...
	"migrations/100_server_tags_migrations.down.sql": {
		name: "100_server_tags_migrations.down.sql",
		bytes: []byte(`
begin;
...
`),
	...
	"migrations/100_server_tags_migrations.up.sql": {
		name: "100_server_tags_migrations.up.sql",
		bytes: []byte(`
begin;
