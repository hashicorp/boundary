...
begin;
  ...
  select is(auth_method_name,              'None')                from wh_user_dimension where user_id = 'u_____walter';
  select is(auth_method_description,       'None')                from wh_user_dimension where user_id = 'u_____walter';
  select is(auth_method_external_id,       'https://widget.test') from wh_user_dimension where user_id = 'u_____walter';
