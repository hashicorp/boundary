...
begin;
  ...
  select is(count(*), 0::bigint) from credential_vault_library_username_password_domain_mapping_ovrd where library_id = 'vl______wvl21';
  select is(count(*), 0::bigint) from credential_vault_library_mapping_override where library_id = 'vl______wvl21';
  ...
  select is(count(*), 1::bigint) from credential_vault_library_username_password_domain_mapping_ovrd where library_id = 'vl______wvl21';
  select is(count(*), 1::bigint) from credential_vault_library_mapping_override where library_id = 'vl______wvl21';
