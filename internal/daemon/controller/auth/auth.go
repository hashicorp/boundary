...
func Verify(ctx context.Context, resourceType resource.Type, opt ...Option) (ret VerifyResults) {
	...
	var err error
	authResults, ret.UserData, ret.Scope, v.acl, ret.grants, err = v.performAuthCheck(ctx, resourceType)
	if err != nil {
...
func (v verifier) performAuthCheck(ctx context.Context, resourceType resource.Type) (
