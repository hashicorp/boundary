...
func validateGetRequest(req *pbs.GetHostCatalogRequest) error {
	return handlers.ValidateGetRequest(handlers.NoopValidatorFn, req, static.HostCatalogPrefix, hostplugin.HostCatalogPrefix, hostplugin.PreviousHostCatalogPrefix)
}
...
func validateUpdateRequest(req *pbs.UpdateHostCatalogRequest) error {
	return handlers.ValidateUpdateRequest(req, req.GetItem(), func() map[string]string {
		...
		return badFields
	}, static.HostCatalogPrefix, hostplugin.HostCatalogPrefix, hostplugin.PreviousHostCatalogPrefix)
}

func validateDeleteRequest(req *pbs.DeleteHostCatalogRequest) error {
	return handlers.ValidateDeleteRequest(handlers.NoopValidatorFn, req, static.HostCatalogPrefix, hostplugin.HostCatalogPrefix, hostplugin.PreviousHostCatalogPrefix)
}
