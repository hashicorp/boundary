...
import (
	...
	"github.com/hashicorp/boundary/internal/daemon/worker/services"
...
func (w *Worker) configureForWorker(ln *base.ServerListener, logger *log.Logger) (func(), error) {
	...
	multihopService := cluster.NewMultihopServiceServer(
	...
	statusSessionService := services.NewWorkerProxyServiceServer(w.controllerStatusConn, w.controllerSessionConn)
