...
func (x *UserPasswordCredential) GetPublicId() string {
	if x != nil {
		return x.PublicId
	}
	return ""
...
func (x *UserPasswordCredential) GetCreateTime() *timestamp.Timestamp {
	if x != nil {
		return x.CreateTime
	}
	return nil
...
func (x *UserPasswordCredential) GetUpdateTime() *timestamp.Timestamp {
	if x != nil {
		return x.UpdateTime
	}
	return nil
...
func (x *UserPasswordCredential) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *UserPasswordCredential) GetDescription() string {
	if x != nil {
		return x.Description
	}
	return ""
...
func (x *UserPasswordCredential) GetStoreId() string {
	if x != nil {
		return x.StoreId
	}
	return ""
...
func (x *UserPasswordCredential) GetVersion() uint32 {
	if x != nil {
		return x.Version
	}
	return 0
...
func (x *UserPasswordCredential) GetPassword() []byte {
	if x != nil {
		return x.Password
	}
	return nil
...
func (x *UserPasswordCredential) GetCtPassword() []byte {
	if x != nil {
		return x.CtPassword
	}
	return nil
...
func (x *UserPasswordCredential) GetPasswordHmac() []byte {
	if x != nil {
...
func (x *UserPasswordCredential) GetKeyId() string {
	if x != nil {
		return x.KeyId
	}
	return ""
...
var file_controller_storage_credential_static_store_v1_static_proto_rawDesc = []byte{
	...
	0x22, 0xf9, 0x04, 0x0a, 0x16, 0x55, 0x73, 0x65, 0x72, 0x50, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72,
	0x64, 0x43, 0x72, 0x65, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x61, 0x6c, 0x12, 0x1b, 0x0a, 0x09, 0x70,
	...
	0x3f, 0x0a, 0x08, 0x75, 0x73, 0x65, 0x72, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x08, 0x20, 0x01, 0x28,
	0x09, 0x42, 0x23, 0xc2, 0xdd, 0x29, 0x1f, 0x0a, 0x08, 0x55, 0x73, 0x65, 0x72, 0x6e, 0x61, 0x6d,
	0x65, 0x12, 0x13, 0x61, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x73, 0x2e, 0x75, 0x73,
	0x65, 0x72, 0x6e, 0x61, 0x6d, 0x65, 0x52, 0x08, 0x75, 0x73, 0x65, 0x72, 0x6e, 0x61, 0x6d, 0x65,
	0x12, 0x3f, 0x0a, 0x08, 0x70, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x18, 0x09, 0x20, 0x01,
	0x28, 0x0c, 0x42, 0x23, 0xc2, 0xdd, 0x29, 0x1f, 0x0a, 0x08, 0x50, 0x61, 0x73, 0x73, 0x77, 0x6f,
	0x72, 0x64, 0x12, 0x13, 0x61, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x73, 0x2e, 0x70,
	...
	,
...
var file_controller_storage_credential_static_store_v1_static_proto_goTypes = []interface{}{
	...
	(*UserPasswordCredential)(nil), // 1: controller.storage.credential.static.store.v1.UserPasswordCredential
...
var file_controller_storage_credential_static_store_v1_static_proto_depIdxs = []int32{
	...
	2, // 2: controller.storage.credential.static.store.v1.UserPasswordCredential.create_time:type_name -> controller.storage.timestamp.v1.Timestamp
	2, // 3: controller.storage.credential.static.store.v1.UserPasswordCredential.update_time:type_name -> controller.storage.timestamp.v1.Timestamp
