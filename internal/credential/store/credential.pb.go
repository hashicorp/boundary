...
type StoreUnion struct {
	...
	Subtype string `protobuf:"bytes,15,opt,name=subtype,proto3" json:"subtype,omitempty"`
}

func (x *StoreUnion) Reset() {
	*x = StoreUnion{}
	if protoimpl.UnsafeEnabled {
...
func (x *StoreUnion) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StoreUnion) ProtoMessage() {}

func (x *StoreUnion) ProtoReflect() protoreflect.Message {
	mi := &file_controller_storage_credential_store_v1_credential_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StoreUnion.ProtoReflect.Descriptor instead.
func (*StoreUnion) Descriptor() ([]byte, []int) {
	return file_controller_storage_credential_store_v1_credential_proto_rawDescGZIP(), []int{5}
}

func (x *StoreUnion) GetPublicId() string {
	if x != nil {
		return x.PublicId
	}
	return ""
...
func (x *StoreUnion) GetProjectId() string {
	if x != nil {
		return x.ProjectId
	}
	return ""
...
func (x *StoreUnion) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *StoreUnion) GetDescription() string {
	if x != nil {
...
func (x *StoreUnion) GetCreateTime() *timestamp.Timestamp {
	if x != nil {
		return x.CreateTime
	}
	return nil
...
func (x *StoreUnion) GetUpdateTime() *timestamp.Timestamp {
	if x != nil {
		return x.UpdateTime
	}
	return nil
...
func (x *StoreUnion) GetVersion() uint32 {
	if x != nil {
		return x.Version
	}
	return 0
...
func (x *StoreUnion) GetDeleteTime() *timestamp.Timestamp {
	if x != nil {
		return x.DeleteTime
	}
	return nil
...
func (x *StoreUnion) GetVaultAddress() string {
	if x != nil {
...
func (x *StoreUnion) GetNamespace() string {
	if x != nil {
		return x.Namespace
	}
	return ""
...
func (x *StoreUnion) GetCaCert() []byte {
	if x != nil {
		return x.CaCert
	}
	return nil
...
func (x *StoreUnion) GetTlsServerName() string {
	if x != nil {
...
func (x *StoreUnion) GetTlsSkipVerify() bool {
	if x != nil {
...
func (x *StoreUnion) GetWorkerFilter() string {
	if x != nil {
...
func (x *StoreUnion) GetSubtype() string {
	if x != nil {
		return x.Subtype
	}
	return ""
...
var file_controller_storage_credential_store_v1_credential_proto_rawDesc = []byte{
	...
	0x62, 0x72, 0x61, 0x72, 0x79, 0x49, 0x64, 0x22, 0xea, 0x04, 0x0a, 0x0a, 0x53, 0x74, 0x6f, 0x72,
	0x65, 0x55, 0x6e, 0x69, 0x6f, 0x6e, 0x12, 0x1b, 0x0a, 0x09, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x63,
	...
	0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x4b, 0x0a, 0x0b, 0x63, 0x72, 0x65, 0x61,
	...
	0x01, 0x28, 0x0d, 0x52, 0x07, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x4b, 0x0a, 0x0b,
	...
	0x2e, 0x76, 0x31, 0x2e, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x52, 0x0a, 0x64,
	0x65, 0x6c, 0x65, 0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x23, 0x0a, 0x0d, 0x76, 0x61, 0x75,
	0x6c, 0x74, 0x5f, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x18, 0x09, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x0c, 0x76, 0x61, 0x75, 0x6c, 0x74, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x1c,
	...
	,
	...
	0x72, 0x65, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x61, 0x6c, 0x2f, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x3b,
...
var file_controller_storage_credential_store_v1_credential_proto_goTypes = []interface{}{
	...
	(*StoreUnion)(nil),          // 5: controller.storage.credential.store.v1.StoreUnion
...
var file_controller_storage_credential_store_v1_credential_proto_depIdxs = []int32{
	6, // 0: controller.storage.credential.store.v1.StoreUnion.create_time:type_name -> controller.storage.timestamp.v1.Timestamp
	6, // 1: controller.storage.credential.store.v1.StoreUnion.update_time:type_name -> controller.storage.timestamp.v1.Timestamp
	6, // 2: controller.storage.credential.store.v1.StoreUnion.delete_time:type_name -> controller.storage.timestamp.v1.Timestamp
