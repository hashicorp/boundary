...
type CredentialStore struct {
	...
	// It is optional.
	// @inject_tag: `gorm:"default:null"`
	CaCert string `protobuf:"bytes,10,opt,name=ca_cert,json=caCert,proto3" json:"ca_cert,omitempty" gorm:"default:null"`
...
func (x *CredentialStore) GetCaCert() string {
	if x != nil {
		return x.CaCert
	}
	return ""
...
type VaultToken struct {
	...
	// token_sha256 is the SHA-256 value of token.
	// @inject_tag: `gorm:"primary_key"`
	TokenSha256 []byte `protobuf:"bytes,1,opt,name=token_sha256,json=tokenSha256,proto3" json:"token_sha256,omitempty" gorm:"primary_key"`
...
func (x *VaultToken) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*VaultToken) ProtoMessage() {}

func (x *VaultToken) ProtoReflect() protoreflect.Message {
	mi := &file_controller_storage_credential_vault_store_v1_vault_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use VaultToken.ProtoReflect.Descriptor instead.
...
func (x *VaultToken) GetTokenSha256() []byte {
	if x != nil {
...
func (x *VaultToken) GetToken() []byte {
	if x != nil {
		return x.Token
	}
	return nil
...
func (x *VaultToken) GetCtToken() []byte {
	if x != nil {
		return x.CtToken
	}
	return nil
...
func (x *VaultToken) GetStoreId() string {
	if x != nil {
		return x.StoreId
	}
	return ""
...
func (x *VaultToken) GetCreateTime() *timestamp.Timestamp {
	if x != nil {
		return x.CreateTime
	}
	return nil
...
func (x *VaultToken) GetUpdateTime() *timestamp.Timestamp {
	if x != nil {
		return x.UpdateTime
	}
	return nil
...
func (x *VaultToken) GetVersion() uint32 {
	if x != nil {
		return x.Version
	}
	return 0
...
func (x *VaultToken) GetLastRenewalTime() *timestamp.Timestamp {
	if x != nil {
...
func (x *VaultToken) GetExpirationTime() *timestamp.Timestamp {
	if x != nil {
...
func (x *VaultToken) GetKeyId() string {
	if x != nil {
		return x.KeyId
	}
	return ""
...
type ClientCertificate struct {
	...
	// It must be set.
	// @inject_tag: `gorm:"not_null"`
	Certificate string `protobuf:"bytes,2,opt,name=certificate,proto3" json:"certificate,omitempty" gorm:"not_null"`
	// certificate_key is the plain-text of the certificate key data. We are
	// not storing this plain-text token in the database.
...
func (x *ClientCertificate) GetCertificate() string {
	if x != nil {
...
type VaultLease struct {
	...
	// create_time is set by the database.
	// @inject_tag: `gorm:"default:current_timestamp"`
	CreateTime *timestamp.Timestamp `protobuf:"bytes,4,opt,name=create_time,json=createTime,proto3" json:"create_time,omitempty" gorm:"default:current_timestamp"`
	// update_time is set by the database.
	// @inject_tag: `gorm:"default:current_timestamp"`
	UpdateTime *timestamp.Timestamp `protobuf:"bytes,5,opt,name=update_time,json=updateTime,proto3" json:"update_time,omitempty" gorm:"default:current_timestamp"`
	// version allows optimistic locking of the resource.
	// @inject_tag: `gorm:"default:null"`
	...
	// @inject_tag: `gorm:"not_null"`
	LeaseId string `protobuf:"bytes,7,opt,name=lease_id,json=leaseId,proto3" json:"lease_id,omitempty" gorm:"not_null"`
	...
	// @inject_tag: `gorm:"default:false"`
	IsRenewable bool `protobuf:"varint,10,opt,name=is_renewable,json=isRenewable,proto3" json:"is_renewable,omitempty" gorm:"default:false"`
}

func (x *VaultLease) Reset() {
	*x = VaultLease{}
	if protoimpl.UnsafeEnabled {
...
func (x *VaultLease) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*VaultLease) ProtoMessage() {}

func (x *VaultLease) ProtoReflect() protoreflect.Message {
	mi := &file_controller_storage_credential_vault_store_v1_vault_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use VaultLease.ProtoReflect.Descriptor instead.
func (*VaultLease) Descriptor() ([]byte, []int) {
	return file_controller_storage_credential_vault_store_v1_vault_proto_rawDescGZIP(), []int{4}
}

func (x *VaultLease) GetPublicId() string {
	if x != nil {
		return x.PublicId
	}
	return ""
...
func (x *VaultLease) GetLibraryId() string {
	if x != nil {
		return x.LibraryId
	}
	return ""
...
func (x *VaultLease) GetSessionId() string {
	if x != nil {
		return x.SessionId
	}
	return ""
...
func (x *VaultLease) GetCreateTime() *timestamp.Timestamp {
	if x != nil {
		return x.CreateTime
	}
	return nil
...
func (x *VaultLease) GetUpdateTime() *timestamp.Timestamp {
	if x != nil {
		return x.UpdateTime
	}
	return nil
...
func (x *VaultLease) GetVersion() uint32 {
	if x != nil {
		return x.Version
	}
	return 0
...
func (x *VaultLease) GetLeaseId() string {
	if x != nil {
		return x.LeaseId
	}
	return ""
...
func (x *VaultLease) GetLastRenewalTime() *timestamp.Timestamp {
	if x != nil {
		return x.LastRenewalTime
	}
	return nil
...
func (x *VaultLease) GetExpirationTime() *timestamp.Timestamp {
	if x != nil {
		return x.ExpirationTime
	}
	return nil
...
func (x *VaultLease) GetIsRenewable() bool {
	if x != nil {
...
var file_controller_storage_credential_vault_store_v1_vault_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x91, 0x04, 0x0a, 0x0f, 0x43, 0x72, 0x65, 0x64, 0x65, 0x6e,
	...
	0x12, 0x17, 0x0a, 0x07, 0x63, 0x61, 0x5f, 0x63, 0x65, 0x72, 0x74, 0x18, 0x0a, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x06, 0x63, 0x61, 0x43, 0x65, 0x72, 0x74, 0x12, 0x26, 0x0a, 0x0f, 0x74, 0x6c, 0x73,
	...
	0x65, 0x12, 0x26, 0x0a, 0x0f, 0x74, 0x6c, 0x73, 0x5f, 0x73, 0x6b, 0x69, 0x70, 0x5f, 0x76, 0x65,
	0x72, 0x69, 0x66, 0x79, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0d, 0x74, 0x6c, 0x73, 0x53,
	0x6b, 0x69, 0x70, 0x56, 0x65, 0x72, 0x69, 0x66, 0x79, 0x22, 0xf3, 0x03, 0x0a, 0x0a, 0x56, 0x61,
	0x75, 0x6c, 0x74, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x21, 0x0a, 0x0c, 0x74, 0x6f, 0x6b, 0x65,
	0x6e, 0x5f, 0x73, 0x68, 0x61, 0x32, 0x35, 0x36, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0b,
	0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x53, 0x68, 0x61, 0x32, 0x35, 0x36, 0x12, 0x14, 0x0a, 0x05, 0x74,
	...
	0x28, 0x0d, 0x52, 0x07, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x56, 0x0a, 0x11, 0x6c,
	0x61, 0x73, 0x74, 0x5f, 0x72, 0x65, 0x6e, 0x65, 0x77, 0x61, 0x6c, 0x5f, 0x74, 0x69, 0x6d, 0x65,
	0x18, 0x08, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2a, 0x2e, 0x63, 0x6f, 0x6e, 0x74, 0x72, 0x6f, 0x6c,
	...
	,
	...
	0x65, 0x5f, 0x6b, 0x65, 0x79, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0e, 0x63, 0x65, 0x72,
	...
	0x79, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x10, 0x63, 0x74, 0x43, 0x65, 0x72, 0x74, 0x69,
	0x66, 0x69, 0x63, 0x61, 0x74, 0x65, 0x4b, 0x65, 0x79, 0x12, 0x15, 0x0a, 0x06, 0x6b, 0x65, 0x79,
	0x5f, 0x69, 0x64, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x6b, 0x65, 0x79, 0x49, 0x64,
	0x22, 0x86, 0x03, 0x0a, 0x11, 0x43, 0x72, 0x65, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x61, 0x6c, 0x4c,
	0x69, 0x62, 0x72, 0x61, 0x72, 0x79, 0x12, 0x1b, 0x0a, 0x09, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x63,
	...
	0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x42, 0x10, 0xc2, 0xdd, 0x29,
	...
	0x6f, 0x6e, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x42, 0x1e, 0xc2, 0xdd, 0x29, 0x1a, 0x0a, 0x0b,
	...
	0x70, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x19, 0x0a, 0x08, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x5f, 0x69,
	...
	0x0d, 0x52, 0x07, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x1d, 0x0a, 0x0a, 0x76, 0x61,
	0x75, 0x6c, 0x74, 0x5f, 0x70, 0x61, 0x74, 0x68, 0x18, 0x08, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09,
	0x76, 0x61, 0x75, 0x6c, 0x74, 0x50, 0x61, 0x74, 0x68, 0x22, 0x86, 0x04, 0x0a, 0x0a, 0x56, 0x61,
	0x75, 0x6c, 0x74, 0x4c, 0x65, 0x61, 0x73, 0x65, 0x12, 0x1b, 0x0a, 0x09, 0x70, 0x75, 0x62, 0x6c,
	...
	0x6e, 0x49, 0x64, 0x12, 0x4b, 0x0a, 0x0b, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x5f, 0x74, 0x69,
	0x6d, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2a, 0x2e, 0x63, 0x6f, 0x6e, 0x74, 0x72,
	0x6f, 0x6c, 0x6c, 0x65, 0x72, 0x2e, 0x73, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x2e, 0x74, 0x69,
	0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x2e, 0x76, 0x31, 0x2e, 0x54, 0x69, 0x6d, 0x65, 0x73,
	0x74, 0x61, 0x6d, 0x70, 0x52, 0x0a, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x54, 0x69, 0x6d, 0x65,
	0x12, 0x4b, 0x0a, 0x0b, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x18,
	...
	0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x19, 0x0a, 0x08, 0x6c, 0x65, 0x61, 0x73, 0x65,
	...
	0x61, 0x6c, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2a, 0x2e,
	...
	0x0a, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0b, 0x69, 0x73, 0x52, 0x65, 0x6e, 0x65, 0x77, 0x61, 0x62,
...
var file_controller_storage_credential_vault_store_v1_vault_proto_goTypes = []interface{}{
	...
	(*VaultToken)(nil),          // 1: controller.storage.credential.vault.store.v1.VaultToken
	...
	(*VaultLease)(nil),          // 4: controller.storage.credential.vault.store.v1.VaultLease
...
var file_controller_storage_credential_vault_store_v1_vault_proto_depIdxs = []int32{
	...
	5,  // 2: controller.storage.credential.vault.store.v1.VaultToken.create_time:type_name -> controller.storage.timestamp.v1.Timestamp
	5,  // 3: controller.storage.credential.vault.store.v1.VaultToken.update_time:type_name -> controller.storage.timestamp.v1.Timestamp
	5,  // 4: controller.storage.credential.vault.store.v1.VaultToken.last_renewal_time:type_name -> controller.storage.timestamp.v1.Timestamp
	5,  // 5: controller.storage.credential.vault.store.v1.VaultToken.expiration_time:type_name -> controller.storage.timestamp.v1.Timestamp
	...
	5,  // 8: controller.storage.credential.vault.store.v1.VaultLease.create_time:type_name -> controller.storage.timestamp.v1.Timestamp
	5,  // 9: controller.storage.credential.vault.store.v1.VaultLease.update_time:type_name -> controller.storage.timestamp.v1.Timestamp
	5,  // 10: controller.storage.credential.vault.store.v1.VaultLease.last_renewal_time:type_name -> controller.storage.timestamp.v1.Timestamp
	5,  // 11: controller.storage.credential.vault.store.v1.VaultLease.expiration_time:type_name -> controller.storage.timestamp.v1.Timestamp
