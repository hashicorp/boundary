...
type CredentialStore struct {
	...
	// It must be set.
	// @inject_tag: `gorm:"not_null"`
	VaultAddress string `protobuf:"bytes,8,opt,name=vault_address,json=vaultAddress,proto3" json:"vault_address,omitempty" gorm:"not_null"`
	// namespace is the vault namespace the credential store should use.
	// It is optional.
	// @inject_tag: `gorm:"default:null"`
	Namespace string `protobuf:"bytes,9,opt,name=namespace,proto3" json:"namespace,omitempty" gorm:"default:null"`
	// ca_cert is a single PEM-encoded CA certificate to verify the Vault
	// server's SSL certificate.
	// It is optional.
	// @inject_tag: `gorm:"default:null"`
	CaCert []byte `protobuf:"bytes,10,opt,name=ca_cert,json=caCert,proto3" json:"ca_cert,omitempty" gorm:"default:null"`
	// tls_server_name is the name to use as the SNI host when connecting to
	// Vault via TLS.
	// It is optional.
	// @inject_tag: `gorm:"default:null"`
	TlsServerName string `protobuf:"bytes,11,opt,name=tls_server_name,json=tlsServerName,proto3" json:"tls_server_name,omitempty" gorm:"default:null"`
	...
	TlsSkipVerify bool `protobuf:"varint,12,opt,name=tls_skip_verify,json=tlsSkipVerify,proto3" json:"tls_skip_verify,omitempty" gorm:"default:false"`
}
...
type CredentialLibrary struct {
	...
	// @inject_tag: `gorm:"default:null"`
	HttpRequestBody string `protobuf:"bytes,10,opt,name=http_request_body,json=httpRequestBody,proto3" json:"http_request_body,omitempty" gorm:"default:null"`
}
...
func (x *CredentialLibrary) GetHttpRequestBody() string {
	if x != nil {
...
type Lease struct {
	...
	// @inject_tag: `gorm:"default:null"`
	Version uint32 `protobuf:"varint,7,opt,name=version,proto3" json:"version,omitempty" gorm:"default:null"`
	// lease_id is the lease ID returned from Vault.
	// @inject_tag: `gorm:"not_null"`
	LeaseId string `protobuf:"bytes,8,opt,name=lease_id,json=leaseId,proto3" json:"lease_id,omitempty" gorm:"not_null"`
...
func (x *Lease) GetPublicId() string {
	if x != nil {
		return x.PublicId
	}
	return ""
...
func (x *Lease) GetLibraryId() string {
	if x != nil {
		return x.LibraryId
	}
	return ""
...
func (x *Lease) GetTokenHmac() []byte {
	if x != nil {
		return x.TokenHmac
	}
	return nil
...
func (x *Lease) GetCreateTime() *timestamp.Timestamp {
	if x != nil {
		return x.CreateTime
	}
	return nil
...
func (x *Lease) GetUpdateTime() *timestamp.Timestamp {
	if x != nil {
		return x.UpdateTime
	}
	return nil
...
func (x *Lease) GetVersion() uint32 {
	if x != nil {
		return x.Version
	}
	return 0
...
func (x *Lease) GetLastRenewalTime() *timestamp.Timestamp {
	if x != nil {
		return x.LastRenewalTime
	}
	return nil
...
func (x *Lease) GetExpirationTime() *timestamp.Timestamp {
	if x != nil {
		return x.ExpirationTime
	}
	return nil
...
func (x *Lease) GetIsRenewable() bool {
	if x != nil {
...
var file_controller_storage_credential_vault_store_v1_vault_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xea, 0x05, 0x0a, 0x0f, 0x43, 0x72, 0x65, 0x64, 0x65, 0x6e,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x69, 0x6f, 0x6e, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x42, 0x1e, 0xc2, 0xdd, 0x29, 0x1a, 0x0a,
	...
	,
	...
	0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x19, 0x0a, 0x08, 0x6c, 0x65, 0x61, 0x73, 0x65, 0x5f,
	0x69, 0x64, 0x18, 0x08, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x6c, 0x65, 0x61, 0x73, 0x65, 0x49,
	...
	0x72, 0x79, 0x2f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x2f, 0x63, 0x72, 0x65, 0x64,
	0x65, 0x6e, 0x74, 0x69, 0x61, 0x6c, 0x2f, 0x76, 0x61, 0x75, 0x6c, 0x74, 0x2f, 0x73, 0x74, 0x6f,
...
var file_controller_storage_credential_vault_store_v1_vault_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_controller_storage_credential_vault_store_v1_vault_proto_goTypes = []interface{}{
	...
	(*Lease)(nil),               // 4: controller.storage.credential.vault.store.v1.Lease
...
var file_controller_storage_credential_vault_store_v1_vault_proto_depIdxs = []int32{
	5,  // 0: controller.storage.credential.vault.store.v1.CredentialStore.create_time:type_name -> controller.storage.timestamp.v1.Timestamp
	5,  // 1: controller.storage.credential.vault.store.v1.CredentialStore.update_time:type_name -> controller.storage.timestamp.v1.Timestamp
	5,  // 2: controller.storage.credential.vault.store.v1.Token.create_time:type_name -> controller.storage.timestamp.v1.Timestamp
	5,  // 3: controller.storage.credential.vault.store.v1.Token.update_time:type_name -> controller.storage.timestamp.v1.Timestamp
	5,  // 4: controller.storage.credential.vault.store.v1.Token.last_renewal_time:type_name -> controller.storage.timestamp.v1.Timestamp
	5,  // 5: controller.storage.credential.vault.store.v1.Token.expiration_time:type_name -> controller.storage.timestamp.v1.Timestamp
	5,  // 6: controller.storage.credential.vault.store.v1.CredentialLibrary.create_time:type_name -> controller.storage.timestamp.v1.Timestamp
	5,  // 7: controller.storage.credential.vault.store.v1.CredentialLibrary.update_time:type_name -> controller.storage.timestamp.v1.Timestamp
	5,  // 8: controller.storage.credential.vault.store.v1.Lease.create_time:type_name -> controller.storage.timestamp.v1.Timestamp
	5,  // 9: controller.storage.credential.vault.store.v1.Lease.update_time:type_name -> controller.storage.timestamp.v1.Timestamp
	5,  // 10: controller.storage.credential.vault.store.v1.Lease.last_renewal_time:type_name -> controller.storage.timestamp.v1.Timestamp
	5,  // 11: controller.storage.credential.vault.store.v1.Lease.expiration_time:type_name -> controller.storage.timestamp.v1.Timestamp
