...
type AuthToken struct {
	...
	// database.
	// @inject_tag: `gorm:"not_null"`
	State string `protobuf:"bytes,15,opt,name=state,proto3" json:"state,omitempty" gorm:"not_null"`
}
...
func (x *AuthToken) GetState() string {
	if x != nil {
		return x.State
	}
	return ""
...
var file_controller_storage_authtoken_store_v1_authtoken_proto_rawDesc = []byte{
	...
	0xeb, 0x04, 0x0a, 0x09, 0x41, 0x75, 0x74, 0x68, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x1b, 0x0a,
	...
	0x52, 0x05, 0x6b, 0x65, 0x79, 0x49, 0x64, 0x12, 0x14, 0x0a, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65,
	0x18, 0x0f, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x42, 0x3e, 0x5a,
	...
	0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x2f, 0x61, 0x75, 0x74, 0x68, 0x74, 0x6f, 0x6b, 0x65,
