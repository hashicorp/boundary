...
type Session struct {
	...
	Token string `protobuf:"bytes,5,opt,name=token,proto3" json:"token,omitempty" gorm:"default:not_null"`
	// The iam_scope_id of the owning scope and must be set.
	// @inject_tag: `gorm:"default:not_null"`
	IamScopeId string `protobuf:"bytes,6,opt,name=iam_scope_id,json=iamScopeId,proto3" json:"iam_scope_id,omitempty" gorm:"default:not_null"`
	// iam_user_id is the public id for the iam user this session is for.
	// @inject_tag: `gorm:"default:not_null"`
	IamUserId string `protobuf:"bytes,7,opt,name=iam_user_id,json=iamUserId,proto3" json:"iam_user_id,omitempty" gorm:"default:not_null"`
	// user id is the public id for the iam user this session is for.
	// @inject_tag: `gorm:"default:not_null"`
	AuthMethodId string `protobuf:"bytes,8,opt,name=auth_method_id,json=authMethodId,proto3" json:"auth_method_id,omitempty" gorm:"default:not_null"`
}
...
var file_controller_storage_usersessions_store_v1_session_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0xbe, 0x02, 0x0a, 0x07, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x12,
	...
	,
	...
	0x2f, 0x75, 0x73, 0x65, 0x72, 0x73, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x2f, 0x73, 0x74,
