...
// listWorkersWithReader returns a slice of *Worker.  It accepts WithLiveness
// and WithLimit options. This method accepts a reader, allowing it to be used
// within a transaction or without.
