...
import (
	...
	pbm "github.com/hashicorp/boundary/sdk/pbs/controller/api/resources/authmethods"
...
func TestOutgoingSplitCookie(t *testing.T) {
	...
	attrs, err := ProtoToStruct(&pbm.AuthTokenResponse{Token: "t_abc_1234567890", TokenType: "cookie"})
	require.NoError(t, err)
	require.NoError(t, OutgoingResponseFilter(context.Background(), rec, &pbs.AuthenticateResponse{Attrs: &pbs.AuthenticateResponse_Attributes{Attributes: attrs}}))
