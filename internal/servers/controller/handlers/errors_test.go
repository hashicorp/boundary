...
func TestApiErrorHandler(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			err:  errors.EDeprecated(errors.WithCode(errors.InvalidPublicId)),
			expected: apiError{
				status: http.StatusInternalServerError,
				inner: &pb.Error{
					Kind:    "Internal",
		...
		},
		{
			...
			err:  errors.EDeprecated(errors.WithCode(errors.InvalidParameter)),
			expected: apiError{
				status: http.StatusInternalServerError,
				inner: &pb.Error{
					Kind:    "Internal",
		...
		},
		{
			...
			err:  errors.EDeprecated(errors.WithCode(errors.InvalidFieldMask)),
			expected: apiError{
				status: http.StatusBadRequest,
				inner: &pb.Error{
					Kind:    "InvalidArgument",
		...
		},
		{
			...
			err:  errors.EDeprecated(errors.WithCode(errors.EmptyFieldMask)),
			expected: apiError{
				status: http.StatusBadRequest,
				inner: &pb.Error{
					Kind:    "InvalidArgument",
		...
		},
		{
			...
			err:  errors.EDeprecated(errors.WithCode(errors.NotUnique)),
			expected: apiError{
				status: http.StatusBadRequest,
				inner: &pb.Error{
					Kind:    "InvalidArgument",
		...
		},
		{
			...
			err:  errors.EDeprecated(errors.WithCode(errors.RecordNotFound)),
			expected: apiError{
				status: http.StatusNotFound,
				inner: &pb.Error{
					Kind:    "NotFound",
		...
		},
		{
			...
			err:  errors.EDeprecated(errors.WithCode(errors.MultipleRecords)),
			expected: apiError{
				status: http.StatusInternalServerError,
				inner: &pb.Error{
					Kind:    "Internal",
		...
		},
		{
			...
			err:  errors.EDeprecated(errors.WithCode(errors.AccountAlreadyAssociated)),
			expected: apiError{
				status: http.StatusBadRequest,
				inner: &pb.Error{
					Kind:    "InvalidArgument",
		...
		},
		{
			...
			err:  errors.EDeprecated(errors.WithCode(errors.InvalidAddress), errors.WithMsg("test msg"), errors.WithWrap(errors.EDeprecated(errors.WithCode(errors.NotNull), errors.WithMsg("inner msg")))),
			expected: apiError{
				status: http.StatusInternalServerError,
				inner: &pb.Error{
					Kind:    "Internal",
		...
		},
		{
			...
			err:  errors.EDeprecated(errors.WithCode(errors.Forbidden), errors.WithMsg("test msg")),
			expected: apiError{
		...
		},
		{
			...
			err:  fmt.Errorf("got error: %w", errors.EDeprecated(errors.WithCode(errors.Forbidden), errors.WithMsg("test msg"))),
			expected: apiError{
				status: http.StatusForbidden,
				inner: &pb.Error{
					Kind:    "Internal",
