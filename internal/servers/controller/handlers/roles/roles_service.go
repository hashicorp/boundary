...
// CreateRole is not yet implemented but will implement the interface pbs.RoleServiceServer.
func (s Service) ListRoles(context.Context, *pbs.ListRolesRequest) (*pbs.ListRolesResponse, error) {
...
func (s Service) CreateRole(ctx context.Context, req *pbs.CreateRoleRequest) (*pbs.CreateRoleResponse, error) {
	...
	return &pbs.CreateRoleResponse{Item: r, Uri: fmt.Sprintf("orgs/%s/users/%s", req.GetOrgId(), r.GetId())}, nil
}
