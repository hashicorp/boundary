...
func (s Service) getFromRepo(ctx context.Context, id string) (*iam.Group, []*iam.GroupMember, error) {
	...
	if g == nil {
		return nil, nil, errors.NewDeprecated(errors.InvalidParameter, op, fmt.Sprintf("group %q not found", id))
	}
	return g, m, err
}
...
func (s Service) deleteFromRepo(ctx context.Context, id string) (bool, error) {
	...
	if err != nil {
		...
		return false, errors.WrapDeprecated(err, op, errors.WithMsg("unable to delete group"))
	}
	return rows > 0, nil
}
...
func (s Service) addMembersInRepo(ctx context.Context, groupId string, userIds []string, version uint32) (*iam.Group, []*iam.GroupMember, error) {
	...
	if err != nil {
		return nil, nil, errors.WrapDeprecated(err, op, errors.WithMsg("unable to look up group after adding memebers"))
	}
	if out == nil {
...
func (s Service) setMembersInRepo(ctx context.Context, groupId string, userIds []string, version uint32) (*iam.Group, []*iam.GroupMember, error) {
	...
	out, m, err := repo.LookupGroup(ctx, groupId)
	if err != nil {
		return nil, nil, errors.WrapDeprecated(err, op, errors.WithMsg("unable to look up group after setting members"))
	}
	if out == nil {
...
func (s Service) removeMembersInRepo(ctx context.Context, groupId string, userIds []string, version uint32) (*iam.Group, []*iam.GroupMember, error) {
	...
	out, m, err := repo.LookupGroup(ctx, groupId)
	if err != nil {
		return nil, nil, errors.WrapDeprecated(err, op, errors.WithMsg("unable to look up group after removing members"))
	}
	if out == nil {
