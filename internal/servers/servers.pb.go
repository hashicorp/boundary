...
// Server is the old message used to relay worker status information and controller addresses. It is deprecated
...
type ServerWorkerStatus struct {
	...
	Name string `protobuf:"bytes,10,opt,name=name,proto3" json:"name,omitempty" gorm:"default:null"`
	// Address for the worker. This must be set.
	// @inject_tag: `gorm:"default:null"`
	Address string `protobuf:"bytes,20,opt,name=address,proto3" json:"address,omitempty" gorm:"default:null"`
	// Tags for workers
	// @inject_tag: `gorm:"-"`
	Tags map[string]*TagValues `protobuf:"bytes,30,rep,name=tags,proto3" json:"tags,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3" gorm:"-"`
}
...
func (x *ServerWorkerStatus) GetTags() map[string]*TagValues {
	if x != nil {
		return x.Tags
	}
	return nil
...
var file_controller_servers_v1_servers_proto_rawDesc = []byte{
	...
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x73, 0x22, 0xe6, 0x01, 0x0a, 0x12, 0x53, 0x65, 0x72, 0x76, 0x65,
	0x72, 0x57, 0x6f, 0x72, 0x6b, 0x65, 0x72, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x12, 0x0a,
	...
	0x28, 0x09, 0x52, 0x07, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x47, 0x0a, 0x04, 0x74,
	0x61, 0x67, 0x73, 0x18, 0x1e, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x33, 0x2e, 0x63, 0x6f, 0x6e, 0x74,
	0x72, 0x6f, 0x6c, 0x6c, 0x65, 0x72, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x73, 0x2e, 0x76,
	0x31, 0x2e, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x57, 0x6f, 0x72, 0x6b, 0x65, 0x72, 0x53, 0x74,
	0x61, 0x74, 0x75, 0x73, 0x2e, 0x54, 0x61, 0x67, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x04,
	0x74, 0x61, 0x67, 0x73, 0x1a, 0x59, 0x0a, 0x09, 0x54, 0x61, 0x67, 0x73, 0x45, 0x6e, 0x74, 0x72,
	...
	0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x73, 0x2e, 0x76, 0x31, 0x2e, 0x54, 0x61, 0x67, 0x56, 0x61,
	...
	0x73, 0x3b, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x73, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}
...
var file_controller_servers_v1_servers_proto_goTypes = []interface{}{
	...
	(*ServerWorkerStatus)(nil),  // 2: controller.servers.v1.ServerWorkerStatus
	nil,                         // 3: controller.servers.v1.Server.TagsEntry
	nil,                         // 4: controller.servers.v1.ServerWorkerStatus.TagsEntry
...
var file_controller_servers_v1_servers_proto_depIdxs = []int32{
	...
	3, // 2: controller.servers.v1.Server.tags:type_name -> controller.servers.v1.Server.TagsEntry
	4, // 3: controller.servers.v1.ServerWorkerStatus.tags:type_name -> controller.servers.v1.ServerWorkerStatus.TagsEntry
	1, // 4: controller.servers.v1.Server.TagsEntry.value:type_name -> controller.servers.v1.TagValues
	1, // 5: controller.servers.v1.ServerWorkerStatus.TagsEntry.value:type_name -> controller.servers.v1.TagValues
