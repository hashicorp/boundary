...
type Session struct {
	...
	// @inject_tag: `gorm:"default:null"`
	HostId string `protobuf:"bytes,30,opt,name=host_id,json=hostId,proto3" json:"host_id,omitempty"`
	// server_id that proxied the session
	// @inject_tag: `gorm:"default:null"`
	ServerId string `protobuf:"bytes,40,opt,name=server_id,json=serverId,proto3" json:"server_id,omitempty"`
	// server_type that proxied the session
	// @inject_tag: `gorm:"default:null"`
	ServerType string `protobuf:"bytes,50,opt,name=server_type,json=serverType,proto3" json:"server_type,omitempty"`
	// @inject_tag: `gorm:"default:null"`
	TargetId string `protobuf:"bytes,60,opt,name=target_id,json=targetId,proto3" json:"target_id,omitempty"`
	// host_set_id for the session
	// @inject_tag: `gorm:"default:null"`
	HostSetId string `protobuf:"bytes,70,opt,name=host_set_id,json=hostSetId,proto3" json:"host_set_id,omitempty"`
	// auth_token_id for the session
	// @inject_tag: `gorm:"default:null"`
	AuthTokenId string `protobuf:"bytes,80,opt,name=auth_token_id,json=authTokenId,proto3" json:"auth_token_id,omitempty"`
	// scope id for the sessopm
	// @inject_tag: `gorm:"default:null"`
	ScopeId string `protobuf:"bytes,90,opt,name=scope_id,json=scopeId,proto3" json:"scope_id,omitempty"`
	// termination_reason for the session
	// @inject_tag: `gorm:"default:null"`
	TerminationReason string `protobuf:"bytes,100,opt,name=termination_reason,json=terminationReason,proto3" json:"termination_reason,omitempty"`
	...
	// @inject_tag: `gorm:"default:null"`
	Port string `protobuf:"bytes,120,opt,name=port,proto3" json:"port,omitempty"`
	// bytes_up total for the session
	// @inject_tag: `gorm:"default:null"`
	BytesUp uint64 `protobuf:"varint,130,opt,name=bytes_up,json=bytesUp,proto3" json:"bytes_up,omitempty"`
	// bytes_down total for the session
	// @inject_tag: `gorm:"default:null"`
	BytesDown uint64 `protobuf:"varint,140,opt,name=bytes_down,json=bytesDown,proto3" json:"bytes_down,omitempty"`
	// create_time from the RDBMS
	// @inject_tag: `gorm:"default:current_timestamp"`
	CreateTime *timestamp.Timestamp `protobuf:"bytes,150,opt,name=create_time,json=createTime,proto3" json:"create_time,omitempty"`
	// update_time from the RDBMS
	// @inject_tag: `gorm:"default:current_timestamp"`
	UpdateTime *timestamp.Timestamp `protobuf:"bytes,160,opt,name=update_time,json=updateTime,proto3" json:"update_time,omitempty"`
	// version for the session
	// @inject_tag: `gorm:"default:null"`
	Version uint32 `protobuf:"varint,170,opt,name=version,proto3" json:"version,omitempty"`
}
...
type SessionState struct {
	...
	// @inject_tag: `gorm:"default:current_timestamp"`
	PreviousEndTime *timestamp.Timestamp `protobuf:"bytes,30,opt,name=previous_end_time,json=previousEndTime,proto3" json:"previous_end_time,omitempty"`
	// start_time from the RDBMS
	// @inject_tag: `gorm:"default:current_timestamp"`
	StartTime *timestamp.Timestamp `protobuf:"bytes,40,opt,name=start_time,json=startTime,proto3" json:"start_time,omitempty"`
	// end_time from the RDBMS
	// @inject_tag: `gorm:"default:current_timestamp"`
	EndTime *timestamp.Timestamp `protobuf:"bytes,50,opt,name=end_time,json=endTime,proto3" json:"end_time,omitempty"`
}
...
func (x *SessionState) GetPreviousEndTime() *timestamp.Timestamp {
	if x != nil {
...
var file_controller_storage_sessions_store_v1_session_proto_rawDesc = []byte{
	...
	0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xe2, 0x04, 0x0a, 0x07, 0x53, 0x65, 0x73, 0x73,
	...
	,
	...
	0x69, 0x6d, 0x65, 0x12, 0x4c, 0x0a, 0x0b, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x5f, 0x74, 0x69,
	0x6d, 0x65, 0x18, 0xa0, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2a, 0x2e, 0x63, 0x6f, 0x6e, 0x74,
	...
	0x65, 0x12, 0x19, 0x0a, 0x07, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x18, 0xaa, 0x01, 0x20,
	0x01, 0x28, 0x0d, 0x52, 0x07, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x22, 0xad, 0x02, 0x0a,
...
var file_controller_storage_sessions_store_v1_session_proto_goTypes = []interface{}{
	...
	(*SessionState)(nil),        // 1: controller.storage.sessions.store.v1.SessionState
...
var file_controller_storage_sessions_store_v1_session_proto_depIdxs = []int32{
	...
	2, // 2: controller.storage.sessions.store.v1.SessionState.previous_end_time:type_name -> controller.storage.timestamp.v1.Timestamp
	2, // 3: controller.storage.sessions.store.v1.SessionState.start_time:type_name -> controller.storage.timestamp.v1.Timestamp
	2, // 4: controller.storage.sessions.store.v1.SessionState.end_time:type_name -> controller.storage.timestamp.v1.Timestamp
