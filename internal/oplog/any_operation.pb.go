...
type OperationOptions struct {
	...
	// with_lookup (see dbw package for docs)
	WithLookup bool `protobuf:"varint,1,opt,name=with_lookup,json=withLookup,proto3" json:"with_lookup,omitempty"`
	// with_limit (see dbw package for docs)
	WithLimit uint32 `protobuf:"varint,2,opt,name=with_limit,json=withLimit,proto3" json:"with_limit,omitempty"`
	// Types that are assignable to WithVersion:
	//	*OperationOptions_WithVersionSet
	//	*OperationOptions_WithVersionValue
	WithVersion isOperationOptions_WithVersion `protobuf_oneof:"with_version"`
	// with_skip_vet_for_write (see dbw package for docs)
	WithSkipVetForWrite bool `protobuf:"varint,5,opt,name=with_skip_vet_for_write,json=withSkipVetForWrite,proto3" json:"with_skip_vet_for_write,omitempty"`
	// with_where_clause (see dbw package for docs)
	WithWhereClause string `protobuf:"bytes,6,opt,name=with_where_clause,json=withWhereClause,proto3" json:"with_where_clause,omitempty"`
	// with_where_clause_args (see dbw package for docs)
	WithWhereClauseArgs []*structpb.Value `protobuf:"bytes,7,rep,name=with_where_clause_args,json=withWhereClauseArgs,proto3" json:"with_where_clause_args,omitempty"`
	// with_order (see dbw package for docs)
	WithOrder string `protobuf:"bytes,8,opt,name=with_order,json=withOrder,proto3" json:"with_order,omitempty"`
	// with_prng_values (see dbw package for docs)
	WithPrngValues []string `protobuf:"bytes,9,rep,name=with_prng_values,json=withPrngValues,proto3" json:"with_prng_values,omitempty"`
	// Types that are assignable to WithOnConflict:
	//	*OperationOptions_WithOnConflictSet
	//	*OperationOptions_WithOnConflictValue
	WithOnConflict isOperationOptions_WithOnConflict `protobuf_oneof:"with_on_conflict"`
}
...
func (x *OperationOptions) GetWithLookup() bool {
	if x != nil {
		return x.WithLookup
	}
	return false
...
func (x *OperationOptions) GetWithLimit() uint32 {
	if x != nil {
		return x.WithLimit
	}
	return 0
...
func (m *OperationOptions) GetWithVersion() isOperationOptions_WithVersion {
	if m != nil {
		return m.WithVersion
	}
	return nil
}

func (x *OperationOptions) GetWithVersionSet() bool {
	if x, ok := x.GetWithVersion().(*OperationOptions_WithVersionSet); ok {
		return x.WithVersionSet
	}
	return false
}

func (x *OperationOptions) GetWithVersionValue() uint32 {
	if x, ok := x.GetWithVersion().(*OperationOptions_WithVersionValue); ok {
		return x.WithVersionValue
	}
	return 0
}
...
func (x *OperationOptions) GetWithOrder() string {
	if x != nil {
		return x.WithOrder
	}
	return ""
...
func (x *OperationOptions) GetWithPrngValues() []string {
	if x != nil {
		return x.WithPrngValues
	}
	return nil
}

func (m *OperationOptions) GetWithOnConflict() isOperationOptions_WithOnConflict {
	if m != nil {
		return m.WithOnConflict
	}
	return nil
}

func (x *OperationOptions) GetWithOnConflictSet() bool {
	if x, ok := x.GetWithOnConflict().(*OperationOptions_WithOnConflictSet); ok {
		return x.WithOnConflictSet
	}
	return false
}

func (x *OperationOptions) GetWithOnConflictValue() *WithOnConflict {
	if x, ok := x.GetWithOnConflict().(*OperationOptions_WithOnConflictValue); ok {
		return x.WithOnConflictValue
	}
	return nil
}

type isOperationOptions_WithVersion interface {
	isOperationOptions_WithVersion()
}

type OperationOptions_WithVersionSet struct {
	WithVersionSet bool `protobuf:"varint,3,opt,name=with_version_set,json=withVersionSet,proto3,oneof"`
}

type OperationOptions_WithVersionValue struct {
	// with_version (see dbw package for docs)
	WithVersionValue uint32 `protobuf:"varint,4,opt,name=with_version_value,json=withVersionValue,proto3,oneof"`
}

func (*OperationOptions_WithVersionSet) isOperationOptions_WithVersion() {}

func (*OperationOptions_WithVersionValue) isOperationOptions_WithVersion() {}

type isOperationOptions_WithOnConflict interface {
	isOperationOptions_WithOnConflict()
}

type OperationOptions_WithOnConflictSet struct {
	WithOnConflictSet bool `protobuf:"varint,10,opt,name=with_on_conflict_set,json=withOnConflictSet,proto3,oneof"`
}

type OperationOptions_WithOnConflictValue struct {
	// with_on_conflict (see dbw package for docs)
	WithOnConflictValue *WithOnConflict `protobuf:"bytes,11,opt,name=with_on_conflict_value,json=withOnConflictValue,proto3,oneof"`
}

func (*OperationOptions_WithOnConflictSet) isOperationOptions_WithOnConflict() {}

func (*OperationOptions_WithOnConflictValue) isOperationOptions_WithOnConflict() {}
...
func (x *ColumnValue) GetValue() *structpb.Value {
	if x != nil {
		return x.Value
	}
	return nil
...
var file_controller_storage_oplog_v1_any_operation_proto_rawDesc = []byte{
	...
	,
	...
	0x66, 0x2e, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x22, 0x50,
	0x0a, 0x0c, 0x43, 0x6f, 0x6c, 0x75, 0x6d, 0x6e, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x73, 0x12, 0x40,
	...
	,
}
...
var file_controller_storage_oplog_v1_any_operation_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
...
var file_controller_storage_oplog_v1_any_operation_proto_depIdxs = []int32{
	...
	7,  // 1: controller.storage.oplog.v1.AnyOperation.field_mask:type_name -> google.protobuf.FieldMask
	7,  // 2: controller.storage.oplog.v1.AnyOperation.null_mask:type_name -> google.protobuf.FieldMask
	2,  // 3: controller.storage.oplog.v1.AnyOperation.options:type_name -> controller.storage.oplog.v1.OperationOptions
	8,  // 4: controller.storage.oplog.v1.OperationOptions.with_where_clause_args:type_name -> google.protobuf.Value
	3,  // 5: controller.storage.oplog.v1.OperationOptions.with_on_conflict_value:type_name -> controller.storage.oplog.v1.WithOnConflict
	4,  // 6: controller.storage.oplog.v1.WithOnConflict.columns:type_name -> controller.storage.oplog.v1.Columns
	6,  // 7: controller.storage.oplog.v1.WithOnConflict.column_values:type_name -> controller.storage.oplog.v1.ColumnValues
	8,  // 8: controller.storage.oplog.v1.ColumnValue.value:type_name -> google.protobuf.Value
	5,  // 9: controller.storage.oplog.v1.ColumnValues.values:type_name -> controller.storage.oplog.v1.ColumnValue
...
func file_controller_storage_oplog_v1_any_operation_proto_init() {
	...
	file_controller_storage_oplog_v1_any_operation_proto_msgTypes[1].OneofWrappers = []interface{}{
		(*OperationOptions_WithVersionSet)(nil),
		(*OperationOptions_WithVersionValue)(nil),
		(*OperationOptions_WithOnConflictSet)(nil),
		(*OperationOptions_WithOnConflictValue)(nil),
	}
