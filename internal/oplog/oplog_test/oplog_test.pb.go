...
func file_controller_storage_oplog_test_v1_oplog_test_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_controller_storage_oplog_test_v1_oplog_test_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_controller_storage_oplog_test_v1_oplog_test_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_controller_storage_oplog_test_v1_oplog_test_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_controller_storage_oplog_test_v1_oplog_test_proto_msgTypes[3].Exporter = func(v any, i int) any {
