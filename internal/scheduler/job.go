...
// JobId is the unique id assigned to the job after registration, it is generated by the
// repository during CreateJob, and uses the job code and name as a seed.
// This id is prefixed with "job_", and should be used when
type JobId string
