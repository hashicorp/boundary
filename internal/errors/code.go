...
const (
	...
	KeyActive                          = 124 // KeyActive is returned if the key could not be revoked because it was the active key
	KeyAlreadyRevoked                  = 125 // KeyAlreadyRevoked is returned if the key was already revoked
	KeyRevocationAlreadyRunning   Code = 126 // KeyRevocationAlreadyRunning represents that a key revocation is already running when an attempt to run again was made
	InvalidKeyRevocationRunState  Code = 127 // InvalidKeyRevocationRunState represents that a key revocation was in an invalid state for the action
