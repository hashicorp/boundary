	...
	"targets": {
		{
			...
			HasDescription:      true,
			Container:           "Scope",
			VersionedActions:    []string{"add-host-sets", "remove-host-sets", "set-host-sets", "add-credential-libraries", "remove-credential-libraries", "set-credential-libraries", "add-credential-sources", "remove-credential-sources", "set-credential-sources"},
		},
		{
			ResourceType:         resource.Target.String(),
			Pkg:                  "targets",
