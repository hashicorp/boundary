...
func (c *Command) Run(args []string) int {
	...
	if c.flagIdSuffix != "" {
		...
		c.DevPasswordAccountId = fmt.Sprintf("%s_%s", password.NewAccountPrefix, c.flagIdSuffix)
		...
		c.DevUnprivilegedPasswordAccountId = fmt.Sprintf("%s_", password.NewAccountPrefix) + strutil.Reverse(strings.TrimPrefix(c.DevPasswordAccountId, fmt.Sprintf("%s_", password.NewAccountPrefix)))
