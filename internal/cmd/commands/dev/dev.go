...
type Command struct {
	*base.Server
	...
	flagPassword                     string
	flagUnprivLoginName              string
	flagUnprivPassword               string
	flagIdSuffix                     string
...
func (c *Command) Flags() *base.FlagSets {
	...
	f.StringVar(&base.StringVar{
		Name:    "unpriv-password",
		Target:  &c.flagUnprivPassword,
		Default: "password",
		EnvVar:  "BOUNDARY_DEV_UNPRIV_PASSWORD",
		Usage:   "Initial unprivileged user login password. If set to the empty string, one will be autogenerated.",
	})

	f.StringVar(&base.StringVar{
		Name:    "unpriv-login-name",
		Target:  &c.flagUnprivLoginName,
		Default: "user",
		EnvVar:  "BOUNDARY_DEV_UNPRIV_LOGIN_NAME",
...
func (c *Command) Run(args []string) int {
	...
	if c.flagIdSuffix != "" {
		...
		c.DevUnprivUserId = "u_" + strutil.Reverse(strings.TrimPrefix(c.DevUserId, "u_"))
	...
	if c.flagUnprivLoginName != "" {
		c.DevUnprivLoginName = c.flagUnprivLoginName
	}
	if c.flagUnprivPassword != "" {
		c.DevUnprivPassword = c.flagUnprivPassword
	}
