...
func NewControllerAdder(ctx context.Context, cmd *base.Command, previousModel tea.Model, width, height int) controllerAdder {
	name := textinput.New()
...
func (m controllerAdder) Init() tea.Cmd {
	return nil
}

func (m controllerAdder) Update(msg tea.Msg) (tea.Model, tea.Cmd) {
	switch msg := msg.(type) {
...
func (m controllerAdder) View() string {
