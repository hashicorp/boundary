...
type RootCertificate struct {
	...
	CtPrivateKey []byte `protobuf:"bytes,65,opt,name=ct_private_key,json=ctPrivateKey,proto3" json:"ct_private_key,omitempty" gorm:"column:private_key;not_null" wrapping:"ct,private_key"`
...
var file_controller_storage_servers_store_v1_root_certificate_proto_rawDesc = []byte{
	...
	0x72, 0x69, 0x76, 0x61, 0x74, 0x65, 0x5f, 0x6b, 0x65, 0x79, 0x18, 0x41, 0x20, 0x01, 0x28, 0x0c,
