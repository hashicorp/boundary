...
const (
  ...
  group by role_id,
	...
	grantsForUserGlobalOrOrgOrProjectResourcesQuery = resourceRoleGrantsForUsers + `,
    global_roles_grant_scopes as (
      select iam_role_global.public_id         as role_id,
             iam_role_global.scope_id          as role_scope_id,
             'global'                          as role_parent_scope_id,
             iam_role_global.grant_scope       as grant_scope,
    ...
    all_roles as (
      select role_id,
             ...
             grant_scope,
             canonical_grant
        from global_roles_grant_scopes
       union
      select role_id,
             role_scope_id,
             role_parent_scope_id,
