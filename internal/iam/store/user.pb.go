...
func (x *User) GetPrimaryScopeId() string {
	if x != nil {
...
var file_controller_storage_iam_store_v1_user_proto_rawDesc = []byte{
	...
	0x73, 0x63, 0x6f, 0x70, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x89, 0x03, 0x0a, 0x04,
	0x55, 0x73, 0x65, 0x72, 0x12, 0x1b, 0x0a, 0x09, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x5f, 0x69,
...
var file_controller_storage_iam_store_v1_user_proto_depIdxs = []int32{
	1, // 0: controller.storage.iam.store.v1.User.create_time:type_name -> controller.storage.iam.store.v1.Timestamp
	1, // 1: controller.storage.iam.store.v1.User.update_time:type_name -> controller.storage.iam.store.v1.Timestamp
	2, // 2: controller.storage.iam.store.v1.User.primary_scope:type_name -> controller.storage.iam.store.v1.Scope
