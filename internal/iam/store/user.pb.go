...
type User struct {
	...
	// @inject_tag: `gorm:"-"`
	FullName string `protobuf:"bytes,90,opt,name=full_name,proto3" json:"full_name,omitempty" gorm:"-"`
	// Output only. email is a string that maps to the user's account email from
	// the scope's primary auth method
	// @inject_tag: `gorm:"-"`
	Email string `protobuf:"bytes,100,opt,name=email,proto3" json:"email,omitempty" gorm:"-"`
}
...
var file_controller_storage_iam_store_v1_user_proto_rawDesc = []byte{
	...
	0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x8e, 0x03, 0x0a, 0x04, 0x55,
	...
	0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x1c, 0x0a, 0x09, 0x66, 0x75, 0x6c, 0x6c, 0x5f,
	0x6e, 0x61, 0x6d, 0x65, 0x18, 0x5a, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x66, 0x75, 0x6c, 0x6c,
	0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x18, 0x64,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x42, 0x38, 0x5a, 0x36, 0x67,
