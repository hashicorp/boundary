...
func file_controller_storage_iam_store_v1_group_member_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_controller_storage_iam_store_v1_group_member_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_controller_storage_iam_store_v1_group_member_proto_msgTypes[1].Exporter = func(v any, i int) any {
