...
type GroupMemberUserAlias struct {
	...
	// @inject_tag: `gorm:"default:current_timestamp"`
	UpdateTime *Timestamp `protobuf:"bytes,3,opt,name=update_time,json=updateTime,proto3" json:"update_time,omitempty" gorm:"default:current_timestamp"`
	// public_id is used to access the GroupMemberUserAlias via an API
	PublicId string `protobuf:"bytes,4,opt,name=public_id,json=publicId,proto3" json:"public_id,omitempty"`
	// FriendlyName is the optional friendly name used to
	// access the GroupMemberUserAlias via an API
	// @inject_tag: `gorm:"default:null"`
	FriendlyName string `protobuf:"bytes,5,opt,name=friendly_name,json=friendlyName,proto3" json:"friendly_name,omitempty" gorm:"default:null"`
	// primary scope id of the PrimaryScope
	// @inject_tag: `gorm:"default:null"`
	...
	// @inject_tag: gorm:"foreignkey:ScopeId"
	PrimaryScope *Scope `protobuf:"bytes,7,opt,name=primary_scope,json=primaryScope,proto3" json:"primary_scope,omitempty" gorm:"foreignkey:ScopeId"`
	// group_id is the Group of this GroupMemberUserAlias.
	GroupId uint32 `protobuf:"varint,9,opt,name=group_id,json=groupId,proto3" json:"group_id,omitempty"`
	// GroupMember type (UserAlias)
	Type     uint32 `protobuf:"varint,10,opt,name=type,proto3" json:"type,omitempty"`
	MemberId uint32 `protobuf:"varint,11,opt,name=member_id,json=memberId,proto3" json:"member_id,omitempty"`
}

func (x *GroupMemberUserAlias) Reset() {
	*x = GroupMemberUserAlias{}
	if protoimpl.UnsafeEnabled {
...
func (x *GroupMemberUserAlias) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GroupMemberUserAlias) ProtoMessage() {}

func (x *GroupMemberUserAlias) ProtoReflect() protoreflect.Message {
	mi := &file_group_member_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GroupMemberUserAlias.ProtoReflect.Descriptor instead.
func (*GroupMemberUserAlias) Descriptor() ([]byte, []int) {
	return file_group_member_proto_rawDescGZIP(), []int{1}
}

func (x *GroupMemberUserAlias) GetId() uint32 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *GroupMemberUserAlias) GetCreateTime() *Timestamp {
	if x != nil {
		return x.CreateTime
	}
	return nil
...
func (x *GroupMemberUserAlias) GetUpdateTime() *Timestamp {
	if x != nil {
		return x.UpdateTime
	}
	return nil
...
func (x *GroupMemberUserAlias) GetPublicId() string {
	if x != nil {
		return x.PublicId
	}
	return ""
...
func (x *GroupMemberUserAlias) GetFriendlyName() string {
	if x != nil {
		return x.FriendlyName
	}
	return ""
...
func (x *GroupMemberUserAlias) GetPrimaryScopeId() uint32 {
	if x != nil {
		return x.PrimaryScopeId
	}
	return 0
...
func (x *GroupMemberUserAlias) GetPrimaryScope() *Scope {
	if x != nil {
		return x.PrimaryScope
	}
	return nil
...
func (x *GroupMemberUserAlias) GetGroupId() uint32 {
	if x != nil {
		return x.GroupId
	}
	return 0
...
func (x *GroupMemberUserAlias) GetType() uint32 {
	if x != nil {
		return x.Type
	}
	return 0
...
func (x *GroupMemberUserAlias) GetMemberId() uint32 {
	if x != nil {
		return x.MemberId
	}
	return 0
...
type GroupMemberView struct {
	...
	GroupId uint32 `protobuf:"varint,9,opt,name=group_id,json=groupId,proto3" json:"group_id,omitempty"`
	// GroupMember type (User or UserAlias)
	Type     uint32 `protobuf:"varint,10,opt,name=type,proto3" json:"type,omitempty"`
	MemberId uint32 `protobuf:"varint,11,opt,name=member_id,json=memberId,proto3" json:"member_id,omitempty"`
}
...
var file_group_member_proto_rawDesc = []byte{
	...
	0x52, 0x08, 0x6d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x49, 0x64, 0x22, 0xec, 0x03, 0x0a, 0x14, 0x47,
	0x72, 0x6f, 0x75, 0x70, 0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x55, 0x73, 0x65, 0x72, 0x41, 0x6c,
	0x69, 0x61, 0x73, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52,
	0x02, 0x69, 0x64, 0x12, 0x58, 0x0a, 0x0b, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x5f, 0x74, 0x69,
	0x6d, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x37, 0x2e, 0x68, 0x61, 0x73, 0x68, 0x69,
	...
	0x70, 0x52, 0x0a, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x58, 0x0a,
	...
	0x61, 0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x1b, 0x0a, 0x09, 0x70, 0x75, 0x62, 0x6c, 0x69,
	0x63, 0x5f, 0x69, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x70, 0x75, 0x62, 0x6c,
	0x69, 0x63, 0x49, 0x64, 0x12, 0x23, 0x0a, 0x0d, 0x66, 0x72, 0x69, 0x65, 0x6e, 0x64, 0x6c, 0x79,
	0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x66, 0x72, 0x69,
	0x65, 0x6e, 0x64, 0x6c, 0x79, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x28, 0x0a, 0x10, 0x70, 0x72, 0x69,
	0x6d, 0x61, 0x72, 0x79, 0x5f, 0x73, 0x63, 0x6f, 0x70, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x06, 0x20,
	...
	0x63, 0x6f, 0x70, 0x65, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x33, 0x2e, 0x68, 0x61, 0x73,
	...
	0x18, 0x0a, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x12, 0x1b, 0x0a, 0x09,
	0x6d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x0d, 0x52,
	0x08, 0x6d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x49, 0x64, 0x22, 0xe7, 0x03, 0x0a, 0x0f, 0x47, 0x72,
	0x6f, 0x75, 0x70, 0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x56, 0x69, 0x65, 0x77, 0x12, 0x0e, 0x0a,
	...
	0x72, 0x79, 0x53, 0x63, 0x6f, 0x70, 0x65, 0x12, 0x19, 0x0a, 0x08, 0x67, 0x72, 0x6f, 0x75, 0x70,
	0x5f, 0x69, 0x64, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x07, 0x67, 0x72, 0x6f, 0x75, 0x70,
	0x49, 0x64, 0x12, 0x12, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0d,
	0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x12, 0x1b, 0x0a, 0x09, 0x6d, 0x65, 0x6d, 0x62, 0x65, 0x72,
	0x5f, 0x69, 0x64, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x08, 0x6d, 0x65, 0x6d, 0x62, 0x65,
	0x72, 0x49, 0x64, 0x42, 0x3a, 0x5a, 0x38, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
...
var file_group_member_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_group_member_proto_goTypes = []interface{}{
	...
	(*GroupMemberUserAlias)(nil), // 1: hashicorp.watchtower.controller.iam.store.v1.GroupMemberUserAlias
	(*GroupMemberView)(nil),      // 2: hashicorp.watchtower.controller.iam.store.v1.GroupMemberView
	(*Timestamp)(nil),            // 3: hashicorp.watchtower.controller.iam.store.v1.Timestamp
	(*Scope)(nil),                // 4: hashicorp.watchtower.controller.iam.store.v1.Scope
}
var file_group_member_proto_depIdxs = []int32{
	3, // 0: hashicorp.watchtower.controller.iam.store.v1.GroupMemberUser.create_time:type_name -> hashicorp.watchtower.controller.iam.store.v1.Timestamp
	3, // 1: hashicorp.watchtower.controller.iam.store.v1.GroupMemberUser.update_time:type_name -> hashicorp.watchtower.controller.iam.store.v1.Timestamp
	4, // 2: hashicorp.watchtower.controller.iam.store.v1.GroupMemberUser.primary_scope:type_name -> hashicorp.watchtower.controller.iam.store.v1.Scope
	3, // 3: hashicorp.watchtower.controller.iam.store.v1.GroupMemberUserAlias.create_time:type_name -> hashicorp.watchtower.controller.iam.store.v1.Timestamp
	3, // 4: hashicorp.watchtower.controller.iam.store.v1.GroupMemberUserAlias.update_time:type_name -> hashicorp.watchtower.controller.iam.store.v1.Timestamp
	4, // 5: hashicorp.watchtower.controller.iam.store.v1.GroupMemberUserAlias.primary_scope:type_name -> hashicorp.watchtower.controller.iam.store.v1.Scope
	3, // 6: hashicorp.watchtower.controller.iam.store.v1.GroupMemberView.create_time:type_name -> hashicorp.watchtower.controller.iam.store.v1.Timestamp
	3, // 7: hashicorp.watchtower.controller.iam.store.v1.GroupMemberView.update_time:type_name -> hashicorp.watchtower.controller.iam.store.v1.Timestamp
	4, // 8: hashicorp.watchtower.controller.iam.store.v1.GroupMemberView.primary_scope:type_name -> hashicorp.watchtower.controller.iam.store.v1.Scope
...
func file_group_member_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_group_member_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GroupMemberUserAlias); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
