...
var file_controller_storage_iam_store_v1_role_proto_rawDesc = []byte{
	...
	0x64, 0x69, 0x73, 0x61, 0x62, 0x6c, 0x65, 0x64, 0x22, 0x93, 0x01, 0x0a, 0x08, 0x55, 0x73, 0x65,
	...
	0x70, 0x61, 0x6c, 0x49, 0x64, 0x22, 0xaf, 0x01, 0x0a, 0x10, 0x41, 0x73, 0x73, 0x69, 0x67, 0x6e,
	0x65, 0x64, 0x52, 0x6f, 0x6c, 0x65, 0x56, 0x69, 0x65, 0x77, 0x12, 0x4b, 0x0a, 0x0b, 0x63, 0x72,
...
var file_controller_storage_iam_store_v1_role_proto_depIdxs = []int32{
	4, // 0: controller.storage.iam.store.v1.Role.create_time:type_name -> controller.storage.timestamp.v1.Timestamp
	4, // 1: controller.storage.iam.store.v1.Role.update_time:type_name -> controller.storage.timestamp.v1.Timestamp
	4, // 2: controller.storage.iam.store.v1.UserRole.create_time:type_name -> controller.storage.timestamp.v1.Timestamp
	4, // 3: controller.storage.iam.store.v1.GroupRole.create_time:type_name -> controller.storage.timestamp.v1.Timestamp
	4, // 4: controller.storage.iam.store.v1.AssignedRoleView.create_time:type_name -> controller.storage.timestamp.v1.Timestamp
