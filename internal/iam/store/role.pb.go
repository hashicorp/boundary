...
var file_controller_storage_iam_store_v1_role_proto_depIdxs = []int32{
	...
	4, // 3: controller.storage.iam.store.v1.GroupRole.create_time:type_name -> controller.storage.iam.store.v1.Timestamp
	4, // 4: controller.storage.iam.store.v1.AssignedRoleView.create_time:type_name -> controller.storage.iam.store.v1.Timestamp
