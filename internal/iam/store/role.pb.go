...
type Role struct {
	...
	// @inject_tag: `gorm:"default:null"`
	GrantScopeId string `protobuf:"bytes,11,opt,name=grant_scope_id,json=grantScopeId,proto3" json:"grant_scope_id,omitempty" gorm:"default:null"`
}
...
var file_controller_storage_iam_store_v1_role_proto_rawDesc = []byte{
	...
	0x65, 0x5f, 0x69, 0x64, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x67, 0x72, 0x61, 0x6e,
