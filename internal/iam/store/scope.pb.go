...
type Scope struct {
	...
	// account_info_auth_method_id specifies which auth method will be used as a
	// source for account information for users within the scope.  This auth
	// method will also be designated as the auth method which will autovivify
	// users.
	// @inject_tag: `gorm:"default:null"`
	AccountInfoAuthMethodId string `protobuf:"bytes,20,opt,name=account_info_auth_method_id,json=accountInfoAuthMethodId,proto3" json:"account_info_auth_method_id,omitempty" gorm:"default:null"`
}
...
func (x *Scope) GetAccountInfoAuthMethodId() string {
	if x != nil {
		return x.AccountInfoAuthMethodId
	}
	return ""
}
...
var file_controller_storage_iam_store_v1_scope_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x61, 0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xaf, 0x03, 0x0a, 0x05,
	...
	0x3c, 0x0a, 0x1b, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x5f,
	0x61, 0x75, 0x74, 0x68, 0x5f, 0x6d, 0x65, 0x74, 0x68, 0x6f, 0x64, 0x5f, 0x69, 0x64, 0x18, 0x14,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x17, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x49, 0x6e, 0x66,
	0x6f, 0x41, 0x75, 0x74, 0x68, 0x4d, 0x65, 0x74, 0x68, 0x6f, 0x64, 0x49, 0x64, 0x42, 0x38, 0x5a,
