...
var file_controller_storage_iam_store_v1_auth_method_proto_depIdxs = []int32{
	1, // 0: controller.storage.iam.store.v1.AuthMethod.create_time:type_name -> controller.storage.timestamp.v1.Timestamp
	1, // 1: controller.storage.iam.store.v1.AuthMethod.update_time:type_name -> controller.storage.timestamp.v1.Timestamp
