...
type RoleGrant struct {
	...
	// private_id is used to access the RoleGrant internally
	...
	RoleId string `protobuf:"bytes,5,opt,name=role_id,json=roleId,proto3" json:"role_id,omitempty" gorm:"default:null"`
	// user_grant is the string grant value as provided by the user
	// @inject_tag: `gorm:"default:null"`
	UserGrant string `protobuf:"bytes,6,opt,name=user_grant,json=userGrant,proto3" json:"user_grant,omitempty" gorm:"default:null"`
	// canonical_grant is the canonical string representation of the grant value.
	// We use this as the unique constraint.
	// @inject_tag: `gorm:"default:null"`
	CanonicalGrant string `protobuf:"bytes,7,opt,name=canonical_grant,json=canonicalGrant,proto3" json:"canonical_grant,omitempty" gorm:"default:null"`
}
...
func (x *RoleGrant) GetPrivateId() string {
	if x != nil {
		return x.PrivateId
	}
	return ""
...
func (x *RoleGrant) GetUpdateTime() *timestamp.Timestamp {
	if x != nil {
		return x.UpdateTime
	}
	return nil
...
func (x *RoleGrant) GetUserGrant() string {
	if x != nil {
		return x.UserGrant
	}
	return ""
...
var file_controller_storage_iam_store_v1_role_grant_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0xa5, 0x02, 0x0a, 0x09, 0x52, 0x6f, 0x6c, 0x65, 0x47, 0x72, 0x61, 0x6e, 0x74, 0x12,
	0x1d, 0x0a, 0x0a, 0x70, 0x72, 0x69, 0x76, 0x61, 0x74, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x09, 0x70, 0x72, 0x69, 0x76, 0x61, 0x74, 0x65, 0x49, 0x64, 0x12, 0x4b,
	...
	0x64, 0x61, 0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x17, 0x0a, 0x07, 0x72, 0x6f, 0x6c, 0x65,
	0x5f, 0x69, 0x64, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x72, 0x6f, 0x6c, 0x65, 0x49,
	0x64, 0x12, 0x1d, 0x0a, 0x0a, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x67, 0x72, 0x61, 0x6e, 0x74, 0x18,
	0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x75, 0x73, 0x65, 0x72, 0x47, 0x72, 0x61, 0x6e, 0x74,
	0x12, 0x27, 0x0a, 0x0f, 0x63, 0x61, 0x6e, 0x6f, 0x6e, 0x69, 0x63, 0x61, 0x6c, 0x5f, 0x67, 0x72,
	0x61, 0x6e, 0x74, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e, 0x63, 0x61, 0x6e, 0x6f, 0x6e,
	0x69, 0x63, 0x61, 0x6c, 0x47, 0x72, 0x61, 0x6e, 0x74, 0x42, 0x3a, 0x5a, 0x38, 0x67, 0x69, 0x74,
...
var file_controller_storage_iam_store_v1_role_grant_proto_depIdxs = []int32{
	...
	1, // 1: controller.storage.iam.store.v1.RoleGrant.update_time:type_name -> controller.storage.timestamp.v1.Timestamp
