...
type RoleGrant struct {
	...
	RoleGrant string `protobuf:"bytes,11,opt,name=role_grant,json=roleGrant,proto3" json:"role_grant,omitempty"`
}

func (x *RoleGrant) Reset() {
	*x = RoleGrant{}
	if protoimpl.UnsafeEnabled {
		mi := &file_role_grant_proto_msgTypes[0]
...
func (*RoleGrant) Descriptor() ([]byte, []int) {
	return file_role_grant_proto_rawDescGZIP(), []int{0}
}

func (x *RoleGrant) GetId() uint32 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *RoleGrant) GetCreateTime() *Timestamp {
	if x != nil {
		return x.CreateTime
	}
	return nil
...
func (x *RoleGrant) GetUpdateTime() *Timestamp {
	if x != nil {
		return x.UpdateTime
	}
	return nil
...
func (x *RoleGrant) GetPublicId() string {
	if x != nil {
		return x.PublicId
	}
	return ""
...
func (x *RoleGrant) GetFriendlyName() string {
	if x != nil {
...
func (x *RoleGrant) GetDescription() string {
	if x != nil {
...
func (x *RoleGrant) GetPrimaryScopeId() uint32 {
	if x != nil {
...
func (x *RoleGrant) GetPrimaryScope() *Scope {
	if x != nil {
...
func (x *RoleGrant) GetOwnerId() uint32 {
	if x != nil {
		return x.OwnerId
	}
	return 0
...
func (x *RoleGrant) GetRoleId() uint32 {
	if x != nil {
		return x.RoleId
	}
	return 0
...
func (x *RoleGrant) GetRoleGrant() string {
	if x != nil {
		return x.RoleGrant
	}
	return ""
...
var File_role_grant_proto protoreflect.FileDescriptor

var file_role_grant_proto_rawDesc = []byte{
	0x0a, 0x10, 0x72, 0x6f, 0x6c, 0x65, 0x5f, 0x67, 0x72, 0x61, 0x6e, 0x74, 0x2e, 0x70, 0x72, 0x6f,
	...
	0x6f, 0x1a, 0x0b, 0x73, 0x63, 0x6f, 0x70, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x8a,
	0x04, 0x0a, 0x09, 0x52, 0x6f, 0x6c, 0x65, 0x47, 0x72, 0x61, 0x6e, 0x74, 0x12, 0x0e, 0x0a, 0x02,
	...
	0x08, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x33, 0x2e, 0x68, 0x61, 0x73, 0x68, 0x69, 0x63, 0x6f, 0x72,
	...
	0x72, 0x5f, 0x69, 0x64, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x07, 0x6f, 0x77, 0x6e, 0x65,
	0x72, 0x49, 0x64, 0x12, 0x17, 0x0a, 0x07, 0x72, 0x6f, 0x6c, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x0a,
	0x20, 0x01, 0x28, 0x0d, 0x52, 0x06, 0x72, 0x6f, 0x6c, 0x65, 0x49, 0x64, 0x12, 0x1d, 0x0a, 0x0a,
	0x72, 0x6f, 0x6c, 0x65, 0x5f, 0x67, 0x72, 0x61, 0x6e, 0x74, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x09, 0x72, 0x6f, 0x6c, 0x65, 0x47, 0x72, 0x61, 0x6e, 0x74, 0x42, 0x3a, 0x5a, 0x38, 0x67,
...
var (
	file_role_grant_proto_rawDescOnce sync.Once
	file_role_grant_proto_rawDescData = file_role_grant_proto_rawDesc
)

func file_role_grant_proto_rawDescGZIP() []byte {
	file_role_grant_proto_rawDescOnce.Do(func() {
		file_role_grant_proto_rawDescData = protoimpl.X.CompressGZIP(file_role_grant_proto_rawDescData)
	})
	return file_role_grant_proto_rawDescData
}

var file_role_grant_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_role_grant_proto_goTypes = []interface{}{
	(*RoleGrant)(nil), // 0: hashicorp.watchtower.controller.iam.store.v1.RoleGrant
...
var file_role_grant_proto_depIdxs = []int32{
	1, // 0: hashicorp.watchtower.controller.iam.store.v1.RoleGrant.create_time:type_name -> hashicorp.watchtower.controller.iam.store.v1.Timestamp
	1, // 1: hashicorp.watchtower.controller.iam.store.v1.RoleGrant.update_time:type_name -> hashicorp.watchtower.controller.iam.store.v1.Timestamp
	2, // 2: hashicorp.watchtower.controller.iam.store.v1.RoleGrant.primary_scope:type_name -> hashicorp.watchtower.controller.iam.store.v1.Scope
...
func init() { file_role_grant_proto_init() }
func file_role_grant_proto_init() {
	if File_role_grant_proto != nil {
		return
	}
	file_timestamp_proto_init()
	file_scope_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_role_grant_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_role_grant_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_role_grant_proto_goTypes,
		DependencyIndexes: file_role_grant_proto_depIdxs,
		MessageInfos:      file_role_grant_proto_msgTypes,
	}.Build()
	File_role_grant_proto = out.File
	file_role_grant_proto_rawDesc = nil
	file_role_grant_proto_goTypes = nil
	file_role_grant_proto_depIdxs = nil
}
