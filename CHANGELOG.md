...
- MinIO storage plugin: You can now create a storage bucket that allows Boundary
  ...
  _Note:_ Due to a library incompatibility, this release is not yet compatible
...
_Note:_ This release fixes an upgrade issue affecting users on Postgres 11
...
_NOTE_: This version requires a database migration via the new `boundary
