---
id: 4686b8a5-b7f8-4424-b75d-7c2d0c87c5dd
...
The Boundary CLI must first be installed on your machine to manage your HCP
Boundary instance. Boundary is available as source code, as a pre-compiled
binary, or in packaged formats.

This tutorial will not cover how to compile Boundary from source, but compiling
from source is covered in the
[README](https://github.com/hashicorp/boundary#build-and-start-boundary-in-dev-mode)
for those who want to be sure they're compiling source they trust into the final
binary.

<Note>

 HCP Boundary requires version 0.12.0 to be installed. Previous versions may not
 function as expected when used with HCP Boundary.
...
tutorial to continue with HCP Boundary.
