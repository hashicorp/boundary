...
1. Use the following command to create a dynamic host catalog for GCP:
  ...
  Refer to [the domain model documentation](/boundary/docs/domain-model/host-catalogs) for additional fields that you can use when you create host catalogs.
...
1. Use the following command to create a host set:
  ...
  For more fields that you can use when creating host sets, refer to [the domain model documentation](/boundary/docs/domain-model/host-sets).
