...
[creating a host sets](/boundary/docs/domain-model/host-sets)
...
- [AWS dynamic host catalogs](/boundary/docs/hosts/discovery/aws)
- [Azure dynamic host catalogs](/boundary/docs/hosts/discovery/azure)
- [GCP dynamic host catalogs](/boundary/docs/hosts/discovery/gcp)
