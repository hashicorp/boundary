...
# Deploy Boundary in a self-managed environment overview
...
architecture](/boundary/docs/architecture/recommended-architecture) topic.
...
1. [Configure workers](/boundary/docs/deploy/self-managed/configure-workers)
