...
To learn about installing end-user clients, refer to the [Install Boundary clients](/boundary/docs/deploy/self-managed/install-clients) page.
...
- [Configure Boundary controllers](/boundary/docs/deploy/self-managed/configure-controllers)
- [Configure Boundary workers](/boundary/docs/deploy/self-managed/configure-workers)
