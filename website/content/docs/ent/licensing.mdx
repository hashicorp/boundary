...
Your HashiCorp account team sends you a valid Boundary license for environment activation.
...
Refer to the sample configurations below:
  ...
  license = "02MV4UU43BK5..."
   ...
   Refer to the [controller](/docs/configuration/controller) configuration  documentation for more information.