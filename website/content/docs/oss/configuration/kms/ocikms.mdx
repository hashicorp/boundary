...
If you want to use Instance Principal, add section configuration below and add further configuration settings as detailed in the [configuration docs](/docs/oss/configuration/).
