...
An optional KMS stanza for configuration encryption purpose can also be specified:
...
KMS types, see our [KMS documentation](/docs/oss/configuration/kms).
...
[`initial_upstreams`](/docs/oss/configuration/worker/overview#initial_upstreams)
