...
the documentation about [TCP Listener](/docs/oss/configuration/listener/tcp).
...
configuration](/docs/oss/configuration/controller#complete-configuration-example)
docs.