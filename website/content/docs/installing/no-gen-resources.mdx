...
$ boundary users add-accounts -id <myuser_user_id> -account <myuser_account_id>
```
...
scopes created above. These roles are similar to the roles created for you in dev mode but declaring them explicitly
