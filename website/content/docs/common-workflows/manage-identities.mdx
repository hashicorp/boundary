...
Identities in Boundary are known as **Principals**. **Principals** are embodied in two types of resources:

1. Users
1. Groups

Both users and groups can be granted access to resources through [permission grants](/docs/concepts/security/permissions) on [roles](/docs/concepts/domain-model/roles).
