...
![The Manage Scopes dialog letd you customize which scopes are associated with a role.](/img/ui/add-role-scopes_light.png#light-theme-only)
![The Manage Scopes dialog letd you customize which scopes are associated with a role.](/img/ui/add-role-scopes_dark.png#dark-theme-only)
