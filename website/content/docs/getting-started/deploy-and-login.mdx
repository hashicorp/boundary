...
Navigate to HashiCorp Cloud Platform and login using your credentials. Click on
the **Boundary (Beta)** tab and click **Deploy Boundary** on the right-hand
pane. 
...
Store the administrator username and password in a safe location. These
credentials will be used when authenticating using the Admin Console, CLI, or
Terraform.

Click **Deploy** after completing the form. It may take a few minutes to
...
Upon completion of the setup wizard you are logged into your HCP Boundary
