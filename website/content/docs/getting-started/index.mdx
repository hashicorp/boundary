...
1. A [HashiCorp Cloud Platform](https://portal.cloud.hashicorp.com/sign-up) account
1. A [Boundary binary](https://www.boundaryproject.io/downloads) in your `$PATH`
1. Optionally, an [installation of Boundary Desktop](https://learn.hashicorp.com/tutorials/boundary/getting-started-desktop-app)
