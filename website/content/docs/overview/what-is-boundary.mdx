...
When you enable [session recording](/boundary/docs/configuration/session-recording) for a target, any sessions in which a user requests access to that target are recorded.
