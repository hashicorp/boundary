...
Boundary provides [auditing](/boundary/docs/concepts/auditing) features via session recording to help organizations address compliance and threat management needs.
