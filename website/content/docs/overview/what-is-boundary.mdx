...
- **HCP Boundary**: a managed offering of Boundary with commercial-only use-cases and features. Boundary's control plane is hosted by HashiCorp and customers have the option of running private workers within their environment.
...
Regardless of which server edition of Boundary you are using, all editions use the same Desktop and CLI clients, which you can download [here](https://developer.hashicorp.com/boundary/downloads).
