...
description: Learn how Boundary enables a zero trust approach to security in which all access transactions are authenticated and authorized based on trusted identity.
---
