...
2. Boundary's [dynamic host catalog](/boundary/tutorials/host-management/aws-host-catalogs)
...
- [Dynamic Host Catalog on AWS](/boundary/tutorials/host-management/aws-host-catalogs)
