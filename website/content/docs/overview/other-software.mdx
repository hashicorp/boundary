...
We also recommend referring to [What is Boundary](/boundary/docs/what-is-boundary) and [Why Boundary](/boundary/docs/what-is-boundary#why-boundary) for a better understanding of Boundary and the problems that it solves.
