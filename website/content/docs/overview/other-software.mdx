...
We also recommend referring to [What is Boundary](/docs/what-is-boundary) and [Why Boundary](/docs/what-is-boundary#why-boundary) for a better understanding of Boundary and the problems that it solves.
...
Instead, Boundary proposes an improvement to the current remote access model, where remote access is granularly granted and established to specific permitted services, but **not** the entire network.
