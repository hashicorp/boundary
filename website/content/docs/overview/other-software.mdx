...
HashiCorp also recommends referring to [What is Boundary](/docs/overview/what-is-boundary) for a better understanding of Boundary and the problems that it solves.
