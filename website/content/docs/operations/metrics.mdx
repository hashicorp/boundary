...
deployment, enabling diagnoses of deployed controllers and workers. The
exported metrics grant greater visibility into the various components of a running
Boundary deployment through Prometheus.

For more information about Prometheus, see the [Prometheus Overview
Guide](https://prometheus.io/docs/introduction/overview). Boundary uses the [OpenMetric
