...
| `boundary_controller_api_ratelimiter_quota_storage_capacity`	| Histogram of storage capacity for API rate limiting quotas. |
| `boundary_controller_api_ratelimiter_quota_storage_usage`		| Histogram of storage usage for API rate limiting quotas. |
