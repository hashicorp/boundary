...
This value indicates whether the worker can connect to an upstream controller.
It can be any of the following states:
   ...
   A channel in this state will switch to the `CONNECTING` state and attempt to establish a connection.
