...
description: >-
  The "accounts" command lets Boundary administrators create and manage account resources. You can associate users with account resources using auth methods.
---
