...
description: >-
  The "credential-libraries create" command creates credential library resources. You can create a generic Vault or Vault SSH certificate credential library.
---
