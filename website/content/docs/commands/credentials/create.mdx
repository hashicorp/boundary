...
The available types are `json`, `ssh-private-key`, `username-password`, and `username-password-domain` (BETA).
...
- `domain (string: "")` - The Active Directory domain name. This value is optional if you specify the domain in the username field.
