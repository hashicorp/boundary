...
**Worker tags & filters (0.1.5):** Enable target traffic to be effectively “tied” to a given set of workers with [worker tags](/boundary/docs/secure/worker-tags), forcing the session to occur through specified workers for a specific target.
