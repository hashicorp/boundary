...
<table>
  ...
  <tr>
    ...
    <br /><br />
    In version 0.18.0 and earlier, there was a maximum number of managed groups allowed for an auth method. If you had over 10,000 managed groups, Boundary may have incorrectly removed users from the groups. This issue is fixed in version 0.18.1. There is no longer a maximum number of managed groups.
    <br /><br />
