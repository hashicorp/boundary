...
# [Boundary v0.10.0](https://www.boundaryproject.io/downloads)
...
without having to manually enter their brokered credentials. Learn more here. 
...
established connection, so that credentials are never exposed to users. 
