...
<table>
  ...
  <tr>
    ...
    <td style={{verticalAlign: 'middle'}}>
      You can now configure dynamic credentials for AWS S3 storage buckets using the Amazon Web Services (AWS) <code>AssumeRole</code> API.
      <br /><br />
      Learn more:&nbsp;
  ...
  <tr>
    ...
    <td style={{verticalAlign: 'middle'}}>
      A new SSH flag, <code>remote-command</code> was introduced to the [boundary connect ssh helper](https://developer.hashicorp.com/boundary/docs/commands/connect/ssh). It lets you run the specified commands on the remote-machine using pass-through arguments.
      <br /><br />
      Learn more:&nbsp;
  ...
  <tr>
    <td style={{verticalAlign: 'middle'}}>
      Improved telemetry <sup>HCP only</sup>
    </td>
    <td style={{verticalAlign: 'middle'}}>
      Improved telemetry was added for HCP Boundary. You can enable telemetry to gather information about your Boundary cluster.
      <br /><br />
      Learn more:&nbsp;
