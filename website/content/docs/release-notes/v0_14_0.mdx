...
<table>
  ...
  <tr>
    ...
    <td style={{verticalAlign: 'middle'}}>
      The LDAP auth method is no longer in beta, it is now fully supported.
      <br /><br />
      Learn more:&nbsp;
  ...
  <tr>
    <td style={{verticalAlign: 'middle'}}>
      AWS <code>AssumeRole</code> support
    </td>
    <td style={{verticalAlign: 'middle'}}>
      The Amazon Web Services (AWS) <code>AssumeRole</code> API is now supported for session recording.
      <br /><br />
      Learn more:&nbsp;
  ...
  <tr>
    ...
    <td style={{verticalAlign: 'middle'}}>
      A new ssh flag, <code>remote-command</code> was introduced. It lets you run a remote command using pass-through arguments.
      <br /><br />
      Learn more:&nbsp;
