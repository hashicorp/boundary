...
Complete the following steps to create an alias for a target:
...
1. Use the following command to create an alias:
   ...
   - `-value=<string>` - Specifies the value of the alias that you want to use in commands to represent the target.
