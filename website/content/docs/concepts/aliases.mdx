...
When you connect to a target using the terminal, you must reference the target ID or target-name & scope-name. As an example, to SSH to a target, you can type `boundary connect ssh -target-id ttcp_123456789`.
