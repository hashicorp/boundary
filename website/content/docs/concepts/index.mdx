...
Alternatively, Boundary can be run locally in [Dev
mode](/docs/oss/installing/dev-mode). Then, learn how to create targets and
initiate a session with [Connect to Your First
Target](/docs/oss/installing/connect-to-dev-target).
