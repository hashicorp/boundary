...
description: >-
  Learn how Boundary uses scopes, auth methods, accounts, users, groups, and roles to control identity and access managment (IAM). View examples of grant strings.
---
