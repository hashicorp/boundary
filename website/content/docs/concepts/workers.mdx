...
page_title: Workers
description: >-
  Workers enable Boundary to proxy traffic to private targets. Understand worker capabilities, configure tags to filter worker tasks, and check worker health.
---
