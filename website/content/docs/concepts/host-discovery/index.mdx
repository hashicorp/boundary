...
description: >-
  Learn how host discovery workflows enable Boundary to discover and onboard new infrastructure resources. Use dynamic host catalogs for automated host discovery.
---
