...
description: >-
  Use dynamic host catalogs to automatically discover Azure resources and add them as hosts in Boundary. Create a host catalog and host set for Azure resources.
---
