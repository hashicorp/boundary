...
that acts as an cheat sheet to help those new to its grant syntax with crafting roles.
...
To learn more about Boundary's access management system, see [IAM](/docs/concepts/security/iam).