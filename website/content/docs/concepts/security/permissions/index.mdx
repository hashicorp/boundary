...
A [grant string](/docs/concepts/security/permissions/grants) is a mapping 
...
To learn about writing grant strings with examples, see [Grant Strings](/docs/concepts/security/permissions/grants).

## Roles

A [role](/docs/concepts/domain-model/roles) maps grant strings to principals (users and groups). 
