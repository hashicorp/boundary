...
description: >-
  Learn how to use filters to reduce the set of Boundary resources returned when you perform a list operation. Filtering list results helps you find information.
---
