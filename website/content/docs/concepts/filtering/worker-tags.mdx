...
description: >-
  Use worker tags to designate specific worker roles in Boundary. Examples include serving specific regions or jobs, such as credential stores or storage buckets.
---
