...
To practice using the `boundary connect` command in a development environment, refer to the [Connecting to your first target](/boundary/tutorials/oss-getting-started/oss-getting-started-connect) tutorial.
