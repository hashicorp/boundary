...
description: >-
  Learn how multi-hop sessions let you chain together two or more Boundary workers across multiple networks to reach a target without exposing private networks.
---
