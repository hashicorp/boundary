...
![Credential brokering](/img/credential-brokering-1-75per-5.png)
...
![Credential brokering](/img/Cred_Brokering.gif|width=454)
...
[![Credential brokering](/img/terminal.gif)](/img/terminal.gif)
...
![Credential injection](/img/credential-injection-1-75per.png)
...
![Credential injection](/img/Cred_Injection.gif|width=75%)
