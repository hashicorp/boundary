...
![Credential brokering animation](/img/Cred_Brokering-animated.gif)
...
![Credential brokering abstracted](/img/terminal.gif)

Zoomed:

![Credential brokering abstracted with `boundary connect` command](/img/terminal-zoom.gif)
...
![Credential injection animation](/img/Cred_Injection-animated.gif)
