...
Brokered credentials can take the form of a token, username password, username domain password, SSH private key, certificate, JSON blob, or an unstructured secret stored in Vault, for example.
