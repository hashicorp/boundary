...
description: >-
  Boundary can use credential brokering or credential injection to authenticate users. Understand the benefits and security considerations of each method.
---
