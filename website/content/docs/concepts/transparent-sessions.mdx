...
| Windows x86 installer prompts for restart | When you install Boundary, the x86 Windows installer occasionally prompts you to restart your computer, however it is not necessary. |
