...
Transparent sessions require [aliases](/docs/concepts/aliases) and the [Boundary Client Agent](/docs/api-clients/client-agent).
...
1. Open the client of your choice and [connect to your target using the alias](/docs/concepts/aliases#connect-to-a-target-using-an-alias).
   ...
   It should not take longer than 2 minutes for the alias to be updated in the Client Agent. If you are seeing connection issues after 2 minutes,
   follow the troubleshooting steps outlined in [the Client Agent troubleshooting guide](/docs/api-clients/client-agent#troubleshooting).
