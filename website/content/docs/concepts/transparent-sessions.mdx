...
To configure transparent sessions for the public beta, you should ensure that the Boundary CLI and Boundary Desktop are not already installed in the environment in which you want to run the transparent sessions beta.
