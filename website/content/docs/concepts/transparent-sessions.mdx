...
Transparent sessions require [aliases](/boundary/docs/concepts/aliases) and the [Boundary Client Agent](/boundary/docs/client-agent).
...
Refer to the [Configure transparent sessions](/boundary/docs/targets/connections/transparent-sessions) page to get started.
...
- [Configure transparent sessions](/boundary/docs/targets/connections/transparent-sessions)
