...
description: >-
  Boundary session connections occur when Boundary creates an authorized proxy between a user and a host. Learn how connections are established and terminated.
---
