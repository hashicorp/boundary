...
description: >-
  Use Boundary aliases to connect to targets without having to provide the target ID or target name and scope ID. Learn how to configure alias attributes.
---
