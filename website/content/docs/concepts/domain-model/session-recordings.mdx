...
description: >-
  Use session recordings to audit user sessions in Boundary. Configure session recording storage policies with retention periods to meet compliance needs.
---
