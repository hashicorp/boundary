...
Refer to the [Manage Scopes with HCP Boundary](https://learn.hashicorp.com/tutorials/boundary/hcp-manage-scopes?in=boundary/hcp-administration) tutorial to learn how to create an org scope and a project scope.
