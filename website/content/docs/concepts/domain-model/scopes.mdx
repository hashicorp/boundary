...
You can include multiple projects within an org.
A project can directly contain:
[roles][], [targets][], [host catalogs][], and [credential stores][].

Projects act as permission domains or boundaries around your infrastructure.
You can use them to organize resources into logical groupings.
They include hosts and the credentials you use to access them.
If you are the admin of a project, you have permissions to define the credentials, hosts, and target mappings that make up the project.
