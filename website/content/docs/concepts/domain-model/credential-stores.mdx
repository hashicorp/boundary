...
description: >-
  Use Boundary credential stores to store and retrieve credentials. Learn which attributes you can configure for Vault credential and static credential stores.
---
