...
description: >-
  Boundary sessions are sets of related connections between users and hosts. Sessions may include credentials. Learn how sessions are created and terminated.
---
