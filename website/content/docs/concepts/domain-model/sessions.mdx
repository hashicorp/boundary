...
Refer to the[] Manage Sessions with HCP Boundary](https://learn.hashicorp.com/tutorials/boundary/hcp-manage-sessions?in=boundary/hcp-administration) tutorial to learn how to start, view, and cancel a session.
