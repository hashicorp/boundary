...
description: >-
  Use Boundary managed groups to group accounts as defined by your identity provider, and assign grants to them. Learn how to configure OIDC and LDAP attributes.
---
