...
description: >-
  Use Boundary credentials to define a user's permissions on a host. Learn about username password, SSH private key, SSH certificate, and JSON credential types.
---
