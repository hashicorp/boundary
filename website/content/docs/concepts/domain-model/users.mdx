...
description: >-
  Use Boundary users to identify a person or entity for the purposes of access control. Learn how to assign groups and roles to users so they inherit permissions.
---
