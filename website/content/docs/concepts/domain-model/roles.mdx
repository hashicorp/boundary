...
description: >-
  Use Boundary roles to group permissions which are then granted to any user or group assigned to the role. Learn about the attributes you can configure for roles.
---
