...
Refer to the [Managed Roles and Permissions with HCP Boundary](https://learn.hashicorp.com/tutorials/boundary/hcp-manage-roles?in=boundary/hcp-administration) tutorial to learn how to create a role in Boundary.
