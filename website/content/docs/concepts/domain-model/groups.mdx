...
description: >-
  Use Boundary groups to create collections of users with the same access control. Any role assigned to a group is automatically assigned to the group's users.
---
