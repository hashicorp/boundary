...
description: >-
  Use Boundary hosts to represent computing elements that you can access from Boundary. You can group hosts in host sets and host catalogs for easier maintenance.
---
