...
- `-account=<string>` - Indicates the account you want to disassociate from the user.
You can specify multiple accounts.
- `-id=<string>` - Indicates the ID of the user you want to disassociate from an account.
