...
- `-recursive` - Runs the list operation recursively into child scopes, if the type supports it.
The default value is `false`.
- `-scope-id=<string>` - Indicates the scope that contains the users you want to list.
