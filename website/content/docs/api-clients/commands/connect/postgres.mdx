...
The Boundary connect POSTGRES helper is written as `boundary connect postgres`.
You can run `boundary connect postgres -h` to see the available options, and arguments.
...
### Boundary connect POSTGRES helper with additional flags and options:
