...
- `-include-terminated` - If you set this value, terminated sessions will be included in the `list` results.
...
The default value is `false`.
- `scope-id=<string>` - The scope from which to list the sessions.
