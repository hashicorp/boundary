...
- `-host-id=<string>` -  Specifies the ID of a host from the target's host sets.
...
- `-id=<string>` - Indicates the ID of the target you want to authorize a session for.
- `-name=<string>` - Specifies the name of the target you want to fetch credentials for, if you want to authorize the session using scope parameters and target name.
- `-scope-id=<string>` - Specifies the scope ID of the target you want to fetch credentials for, if you want to authorize the session using scope parameters and target name.
...
- `-scope-name=<string>` - Specifies the scope name of the target you want to fetch credentials for, if you want to authorize the session using scope parameters and target name.
