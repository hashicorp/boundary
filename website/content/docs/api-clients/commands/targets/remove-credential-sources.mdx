...
- `-brokered-credential-source=<string>` - Indicates the credential source you want to remove.
You may specify multiple credential sources.
- `-id=<string>` - Indicates the ID of the target you want to remove the credential source from.
- `-injected-application-credential-source=<string>` - Indicates the credential source you want to remove.
You may specify multiple credential sources.
