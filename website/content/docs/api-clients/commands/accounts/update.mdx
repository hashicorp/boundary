...
- `-id` `(string: "")` - Indicates the ID of the account to update.
- `-name` `(string: "")` - Specifies the name to set on the account.
- `-version` `(string: "")` - Indicates the version of the account against which to
