...
You can check the progress of the key destruction job using the [`boundary scopes list-key-version-destruction-jobs`](/boundary/docs/api-clients/commands/scopes/list-key-version-destruction-jobs) command.
