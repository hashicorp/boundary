...
- [delete](/boundary/docs/api-clients/commands/scopes/delete)
- [destroy-key-version](/boundary/docs/api-clients/commands/scopes/destroy-key-version)
- [list](/boundary/docs/api-clients/commands/scopes/list)
- [list-key-version-destruction-jobs](/boundary/docs/api-clients/commands/scopes/list-key-version-destruction-jobs)
- [list-keys](/boundary/docs/api-clients/commands/scopes/list-keys)
- [read](/boundary/docs/api-clients/commands/scopes/read)
- [rotate-keys](/boundary/docs/api-clients/commands/scopes/rotate-keys)
- [update](/boundary/docs/api-clients/commands/scopes/update)