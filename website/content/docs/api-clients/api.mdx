...
If you enable API rate limiting, Boundary creates quotas to track the number of requests in a given time period.
You can configure Boundary to track the total number of requests or track requests by auth token or IP address.
