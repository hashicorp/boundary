...
Refer to [RDP credential injection compatibility](/boundry/docs/credentials/rdp-testing-and-compatibility-matrix) for more information about what is supported for the beta RDP release.
