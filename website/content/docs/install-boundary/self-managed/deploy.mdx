...
To learn about installing end-user clients, refer to the [Install Boundary clients](/boundary/docs/install-boundary/self-managed/install-clients) page.
...
- [Configure Boundary controllers](/boundary/docs/install-boundary/self-managed/configure-controllers)
