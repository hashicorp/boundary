...
Before you initialize Boundary, you should have [initialized a database](/boundary/docs/install-boundary/self-managed/configure-controllers#initialize-the-database).
