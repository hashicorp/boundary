...
Further, HashiCorp strongly recommends that you use certificates that an appropriate certificate authority (CA) generated and signed.
...
It encrypts the DEKs using the scope's KEK, and then encrypts the DEKs with the KMS key marked for the root purpose.
