...
- **Credential Stores**
    ...
    - [Vault[(/docs/resources/credential_store_vault)](/docs/resources/credential_store_vault)
...
For more clientInformation, please refer to the Terraform provider documentation on [targets](/docs/resources/target)