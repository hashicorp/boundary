...
- **Username password domain** (BETA): Username, password, and domain for Windows environments that use Active Directory authentication, it is commonly used for credential injection when connecting to an RDP target requires that you specify a domain
