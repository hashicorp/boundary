...
- **Username password domain** (BETA): Username, password, and domain for Windows environments that use Active Directory authentication, it is commonly used with RDP targets for credential injection
