...
- **Transparent sessions:** RDP transparent sessions on Windows clients requires a custom port configuration due to a conflict with the default port `3389`. Refer to the workarounds below.
