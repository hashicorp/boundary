...
Refer to the following topics for information on the various ways to monitor Boundary:

- [Listeners](/boundary/docs/monitor/listener)
   - [TCP listeners](/boundary/docs/monitor/listener/tcp)
   - [Unix listeners](/boundary/docs/monitor/listener/unix)
