...
1. Refer to [Manage roles and permissions](/boundary/docs/rbac/permissions/manage-roles) for instructions to configure roles and grant scopes for principals.
