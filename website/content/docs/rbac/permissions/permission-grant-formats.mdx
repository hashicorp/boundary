...
Refer to [Assignable permissons](/boundary/docs/rbac/permissions/assignable-permissions) for more information about the permissions you can include in grants.
...
Refer to [Manage roles and permissions](/boundary/docs/rbac/permissions/manage-roles) for instructions to configure roles and grant scopes for principals.
