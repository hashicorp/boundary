...
The next level of access management is a [Grant](/boundary/docs/rbac/permissions#grant-strings). A grant in Boundary contains an action(s) and the resource(s) that the action(s) are permitted to be performed against. This can be thought of like a rule.
...
[permission]: /boundary/docs/rbac/permissions
[permissions]: /boundary/docs/rbac/permissions
