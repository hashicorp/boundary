...
- `egress_worker_filter` - (optional)
  ...
  You can configure an egress filter to enable [multi-hop](/boundary/docs/workers#multi-hop-worker-capabilities) connections.
...
[filter]: /boundary/docs/secure/worker-tags
[worker filtering]: /boundary/docs/secure/worker-tags
