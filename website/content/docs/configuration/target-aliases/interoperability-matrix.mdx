...
<table>
  <thead>
    <tr>
      ...
      <th style={{verticalAlign: 'middle', width: '50%'}}>Version</th>
      <th style={{verticalAlign: 'middle', width: '0%'}}>Boundary installer versions</th>
      <th style={{veritcalAlign: 'middle', width: '0%'}}>Boundary Client Agent versions</th>
      <th style={{verticalAlign: 'middle', width: '50%'}}>OS versions</th>
