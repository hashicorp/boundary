...
Due to the declarative nature of Terraform, policies are updated by modifying your existing Terraform configuration. To perform the requested changes, update your existing block of code as shown below, and then execute `terraform apply`.
