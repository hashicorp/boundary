...
Due to the declarative nature of Terraform, you update an existing policy, simply by updating your existing Terraform block of code. To perform the requested changes, update your existing block of code as shown below, and run `terraform apply`.
...
Once the policy changes have been applied with Terraform, you can re-apply the policy as needed by following the CLI instructions in this section.
