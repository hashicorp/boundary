...
- A MinIO storage bucket
   ...
   HashiCorp continuously tests MinIO versions as they are released to confirm that they work as storage buckets.
   At this time, the latest tested and supported version is `RELEASE.2024-10-02T17-50-4Z`.
