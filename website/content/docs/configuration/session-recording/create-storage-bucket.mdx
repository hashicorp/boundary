...
1. Use the following command to create a storage bucket:
    ...
    Replace the values above with the following required AWS secrets and any optional [attributes](/boundary/docs/concepts/domain-model/storage-bucket) you want to associate with the storage bucket:
