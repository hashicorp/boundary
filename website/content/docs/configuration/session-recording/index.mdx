...
To enable session recording you must first [create a storage bucket](/docs/configuration/session-recording/create-storage-bucket) and then [enable session recording on the target](/docs/configuration/session-recording/enable-session-recording).