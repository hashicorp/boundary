...
Boundary supports credential management using [credential stores](/docs/concepts/domain-model/credential-stores), which are resources that store credentials for various targets. 
