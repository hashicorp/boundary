---
layout: docs
page_title: Manage static credential with Boundary and Vault
description: |-
  How to configure static credentials with Vault credential store 
---

# Manage static credentials with Boundary and Vault
...
9. Select the appropriate credential library that corresponds to your target and click **Add BInjected Application Credentials**.
