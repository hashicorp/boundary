...
1. (Optional) If you have a static credential, you can add it into the static credential store. Static credential types can be a username and password, username and keypair, or JSON blob.

The command arguments vary depending on the type of static credential you want to add to the credential store.
