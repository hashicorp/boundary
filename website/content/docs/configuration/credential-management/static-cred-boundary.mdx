...
###  Configure targets with credential injection (HCP/Enterprise)

The following section provides steps to configure your targets with credential injection in order to provide end users with a passwordless experience when connecting to a target.
