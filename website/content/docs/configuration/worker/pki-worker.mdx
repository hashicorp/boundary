...
Refer to the [Self-Managed Worker Registration with HCP Boundary](https://learn.hashicorp.com/tutorials/boundary/hcp-manage-workers?in=boundary/hcp-administration) tutorial to learn how to register and manage PKI workers.
