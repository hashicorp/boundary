...
For Boundary Enterprise, you can configure ingress, intermediary, and egress workers to take advantage of [multi-hop worker capabilities](/boundary/docs/workers/multi-hop#multi-hop-worker-capabilities).
...
Refer to [Multi-hop sessions](/boundary/docs/workers/multi-hop#multi-hop-sessions) for more information.
