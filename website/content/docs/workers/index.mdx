...
[Multi-hop](/boundary/docs/workers/multi-hop) capabilities, including multi-hop sessions and Vault private access,
...
[target worker filters]: /boundary/docs/workers/worker-tags

## More information

To learn more about workers and deployment, see:

* [Worker configuration](/boundary/docs/configuration/workers)
