...
[workers]: /boundary/docs/workers/configure-workers/registration
[credential stores]: /boundary/docs/domain-model/credential-stores#vault-credential-store-attributes
