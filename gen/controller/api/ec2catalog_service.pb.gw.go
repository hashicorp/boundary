...
func request_ControllerService_UpdateEc2Catalog_1(ctx context.Context, marshaler runtime.Marshaler, client ControllerServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq UpdateEc2CatalogRequest
	var metadata runtime.ServerMetadata
...
func local_request_ControllerService_UpdateEc2Catalog_1(ctx context.Context, marshaler runtime.Marshaler, server ControllerServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq UpdateEc2CatalogRequest
	var metadata runtime.ServerMetadata
...
func RegisterControllerServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ControllerServiceServer) error {
	...
	mux.Handle("PATCH", pattern_ControllerService_UpdateEc2Catalog_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req)
		...
		resp, md, err := local_request_ControllerService_UpdateEc2Catalog_1(rctx, inboundMarshaler, server, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_ControllerService_UpdateEc2Catalog_1(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterControllerServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ControllerServiceClient) error {
	...
	mux.Handle("PATCH", pattern_ControllerService_UpdateEc2Catalog_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_ControllerService_UpdateEc2Catalog_1(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_ControllerService_UpdateEc2Catalog_1 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"v1", "ec2_catalogs", "catalog.id"}, "", runtime.AssumeColonVerbOpt(true)))
...
var (
	...
	forward_ControllerService_UpdateEc2Catalog_1 = runtime.ForwardResponseMessage
