...
type Host struct {
	...
	// Must be in the format "org/<org_id>/project/<project_id>/host_catalogs/<catalog_id>/hosts/<host_id>"
...
var file_controller_api_resource_v1_host_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0xc9, 0x02, 0x0a, 0x04, 0x48, 0x6f, 0x73, 0x74, 0x12, 0x10, 0x0a, 0x03, 0x75,
	0x72, 0x69, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x75, 0x72, 0x69, 0x12, 0x41, 0x0a,
	...
	0x56, 0x61, 0x6c, 0x75, 0x65, 0x52, 0x07, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x42, 0x46,
...
var file_controller_api_resource_v1_host_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
...
var file_controller_api_resource_v1_host_proto_depIdxs = []int32{
	1, // 0: controller.api.resource.v1.Host.friendly_name:type_name -> google.protobuf.StringValue
	2, // 1: controller.api.resource.v1.Host.created_time:type_name -> google.protobuf.Timestamp
	2, // 2: controller.api.resource.v1.Host.updated_time:type_name -> google.protobuf.Timestamp
	3, // 3: controller.api.resource.v1.Host.disabled:type_name -> google.protobuf.BoolValue
	1, // 4: controller.api.resource.v1.Host.address:type_name -> google.protobuf.StringValue
