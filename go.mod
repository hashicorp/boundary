...
require (
	...
	github.com/hashicorp/boundary-plugin-host-azure v0.0.0-20210915201545-297203792739
	github.com/hashicorp/boundary/api v0.0.18
	github.com/hashicorp/boundary/sdk v0.0.11-0.20210926154843-a834a147850b
