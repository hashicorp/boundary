...
scenario "pki_worker_testing" {
  ...
  step "create_worker" {
    ...
    variables {
      ...
      worker_type_tags          = ["silly", "farty"]
      private_key_path          = local.aws_ssh_private_key_path
  ...
  // step "create_targets_with_tag2" {
  //   module     = module.target
  //   depends_on = [step.create_base_infra, step.create_worker]
  //   variables {
  //     ami_id               = step.create_base_infra.ami_ids["ubuntu"]["amd64"]
  //     aws_ssh_keypair_name = var.aws_ssh_keypair_name
  //     enos_user            = var.enos_user
  ...
  //     vpc_id               = step.create_base_infra.vpc_id
  //     target_count         = 1
  //     subnet_ids           = step.create_worker.subnet_ids
  //     additional_tags      = step.create_tag2_inputs.tag_map
  //   }
  // }
