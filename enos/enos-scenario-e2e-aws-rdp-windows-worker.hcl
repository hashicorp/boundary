...
scenario "e2e_aws_rdp_windows_worker" {
  ...
  step "create_windows_worker" {
    ...
    variables {
      vpc_id                        = step.create_base_infra.vpc_id
      server_version                = matrix.rdp_server
      domain_admin_password         = step.create_rdp_server.password
      ...
      active_directory_domain       = step.create_rdp_server.active_directory_domain
      active_directory_netbios_name = step.create_rdp_server.active_directory_netbios_name
    }
  }
