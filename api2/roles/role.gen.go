...
func (s *RoleClient) Read(ctx context.Context, id string, opts ...api.Option) (*Role, *api.Error, error) {
	if id == "" {
...
func (s *RoleClient) Delete(ctx context.Context, id string, opts ...api.Option) (bool, *api.Error, error) {
	if id == "" {
